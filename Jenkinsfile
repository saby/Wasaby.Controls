        ...
        stage("Checkout"){
            parallel (
                checkout1: {
                    ...
                    if ( skip ) {
                         dir("./controls/tests") {
                             tests_for_skip_int = sh returnStdout: true, script: "python3 helper.py -efrc ${version} -tt int"
                             tests_for_skip_reg = sh returnStdout: true, script: "python3 helper.py -efrc ${version} -tt reg""
