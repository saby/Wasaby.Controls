...
@ddt
class TestTreeCompositeViewTile(TestCaseUI):
    """Интеграционное тестирование SBIS3.CONTROLS - Тестирование TreeCompositeView Tile"""
    ...
    def update_table_view(self):
        ...
        # TreeCompositeViewListAndTile
        self.db.execute('DELETE FROM "TreeCompositeViewTile";')
        self.db.execute('INSERT INTO "TreeCompositeViewTile" ("@TreeCompositeViewTile", "translate", "parent@") '
        ...
        self.db.execute('INSERT INTO "TreeCompositeViewTile" '
                        '("@TreeCompositeViewTile", "translate", "parent", "parent@") '
        ...
        self.db.execute('INSERT INTO "TreeCompositeViewTile" ("@TreeCompositeViewTile", "translate", "parent") '
                        'VALUES(16, \'Darova\', 5)')
        self.db.execute('INSERT INTO "TreeCompositeViewTile" '
                        '("@TreeCompositeViewTile", "translate") VALUES(17, \'Тест\')')
        self.db.execute('SELECT pg_catalog.setval(pg_get_serial_sequence(\'"TreeCompositeViewTile"\', '
                        '\'@TreeCompositeViewTile\'), 18, false)')
    ...
    def setup(self):
        ...
        self.browser.open(self.config.SITE + '/integration_treecompositeview_tile.html')
    ...
    def test_03_delete_node(self, value):
        """03. Тест проверки удаления узла в tree composite view tile"""
        ...
        for node in wrong_root:
            assert_that(lambda: page.lists_clst.item(contains_text=node).is_displayed is False, is_(True),
                        'Не нужная запись - %s есть в TreeCompositeView' % node, and_wait())
            
    @data(False, True)
    def test_04_delete_node_in_folder(self, value):
        """04. Тест проверки удаления узла в папке tree composite view tile"""
    ...
    def test_05_delete_folder_in_folder(self, value):
        """05. Тест проверки удаления папки в папке tree composite view tile"""
