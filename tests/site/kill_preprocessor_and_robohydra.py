...
try:
	proc_cls = ProcInfo()
	proc_cls.kill_proc_by_name('cmd.exe', 'start_preprocessor_controls373.bat', kill_all = True, tmp_wait = 3)
...
try:
	proc_cls = ProcInfo()
	proc_cls.kill_proc_by_name('cmd.exe', 'start_robohydra_controls373.bat', kill_all = True, tmp_wait = 3)
