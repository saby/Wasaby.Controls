define('js!SBIS3.TestTreeCompositeViewTile',
    [
        'js!SBIS3.CORE.CompoundControl',
        'js!SBIS3.CONTROLS.PathSelector',
        'html!SBIS3.TestTreeCompositeViewTile',
        'js!SBIS3.CONTROLS.SbisServiceSource',
        'css!SBIS3.TestTreeCompositeViewTile',
        ...
        var moduleClass = CompoundControl.extend({
            ...
            init: function () {
                ...
                var multiViewSource = new SbisServiceSource({resource: 'TreeCompositeViewTile'});
        ...
        moduleClass.webPage = {
            outFileName: "integration_treecompositeview_tile",
