define('js!SBIS3.TestTreeCompositeViewTable',
    [
        'js!SBIS3.CORE.CompoundControl',
        'js!SBIS3.CONTROLS.PathSelector',
        'html!SBIS3.TestTreeCompositeViewTable',
        'js!SBIS3.CONTROLS.SbisServiceSource',
        'css!SBIS3.TestTreeCompositeViewTable',
        ...
        var moduleClass = CompoundControl.extend({
            ...
            init: function () {
                ...
                var multiViewSource = new SbisServiceSource({resource: 'TreeCompositeViewTable'});
        ...
        moduleClass.webPage = {
            outFileName: "integration_treecompositeview_table",
