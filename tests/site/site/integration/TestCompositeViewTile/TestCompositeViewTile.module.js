define('js!SBIS3.TestCompositeViewTile',
    [
        'js!SBIS3.CORE.CompoundControl',
        'js!SBIS3.CONTROLS.PathSelector',
        'html!SBIS3.TestCompositeViewTile',
        'js!SBIS3.CONTROLS.SbisServiceSource',
        'css!SBIS3.TestCompositeViewTile',
        ...
        var moduleClass = CompoundControl.extend({
            ...
            init: function () {
                ...
                var multiViewSource = new SbisServiceSource({endpoint: 'CompositeViewTile'});
        ...
        moduleClass.webPage = {
            outFileName: "integration_compositeview_tile",
