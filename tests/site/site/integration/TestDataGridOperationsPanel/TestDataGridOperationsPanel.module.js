define('js!TestDataGridOperationsPanel',
    [
        'js!SBIS3.CORE.CompoundControl',
        'html!TestDataGridOperationsPanel',
        ...
        'css!TestDataGridOperationsPanel'
        ...
        var moduleClass = CompoundControl.extend({
            ...
            init: function () {
                ...
                var arrayStrategy = new ArrayStrategy(),
                    ds1 = new SbisServiceSource({endpoint: 'ЗаметкаПанельОпераций'}),
                    ds2 = new StaticSource({
                        data: bigColls,
                        keyField: '@ЗаметкаПанельОпераций',
        ...
        moduleClass.webPage = {
            outFileName: "integration_datagrid_operations_panel",
