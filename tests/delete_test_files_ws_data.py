...
delete_files('_VDOM', '_Grids', 'IntComboBox', 'IntDropdownList')


os.chdir(r'_Grids')
root_grid = os.getcwd()
delete_files('IntCompositeViewList', 'IntDataGrid', 'IntTreeDataGrid', 'IntTreeView')

os.chdir(r'IntCompositeViewList')
delete_files()

os.chdir(os.path.join(root_grid, r'IntDataGrid'))
delete_files('DG7', 'DG13', 'DG11', 'DGPlace')

os.chdir(r'DGPlace')
delete_files('DGPlace2', 'DGPlace38', 'DGPlace16', 'DGPlace44')

os.chdir(os.path.join(root_grid, r'IntTreeDataGrid'))
delete_files('TDG12', 'TDG5', 'TDG6', 'TDGMove', 'TDG4', 'TDG_model')

os.chdir(os.path.join(root_grid, r'IntTreeView'))
delete_files('IntTreeView1')
