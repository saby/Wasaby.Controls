...
define([
   ...
   describe('Controls.List.BaseControl', function() {
      ...
      describe('ItemActions', function() {
         ...
         it('virtualScrolling enabled', function(done) {
            var source = new MemorySource({
               idProperty: 'id',
               data: data
            });
            ...
            ctrl._beforeMount(cfg)
               .addCallback(function() {
                  assert.equal(!ctrl._virtualScroll, false);
                  assert.equal(ctrl._virtualScroll._options.virtualPageSize, 9);
                  done();
               });
            return done;
         });

         it('virtualScrolling disabled', function(done) {
            var source = new MemorySource({
               idProperty: 'id',
               data: data
            });
         ...
         //       virtualScrolling: true,
         //       virtualPageSize: 9,
         //       _itemsHeights: [10, 20, 30, 40, 5, 10, 15, 20],
         //    };
         //    var ctrl = new BaseControl(cfg);
         //
         //    ctrl._beforeMount(cfg).addCallback(function() {
         //       assert.equal(ctrl._private.getItemsHeight(ctrl, 0, 5), 105);
         //       assert.equal(ctrl._private.getItemsHeight(ctrl, 0, 15), 0);
         //       assert.equal(ctrl._private.getItemsHeight(ctrl, 5, 8), 45);
         //       done();
         //    });
         //    return done;
         // });
         //
         // it('updateVirtualWindow down', function() {
         //    var source = new MemorySource({
         //       idProperty: 'id',
         //       data: data
         //    });
         ...
         //    ctrl._beforeMount(cfg);
         //
         //    ctrl.getCenterItemIndex = function(){
         //       return 7;
         //    };
         //
         //    ctrl._private.updateVirtualWindow(ctrl, "down");
         //
         // });
      });
   });
