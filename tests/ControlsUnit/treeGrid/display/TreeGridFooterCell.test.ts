...
describe('Controls/_treeGridNew/display/TreeGridFooterCell', () => {
   ...
   it ('.getWrapperClasses()', () => {
      ...
      CssClassesAssert.isSame(footerCell.getWrapperClasses('default'), 'controls-Grid__footer-cell controls-GridView__footer__cell_theme-default controls-background-undefined_theme-default controls-ListView__footer__paddingLeft_default_theme-default controls-TreeGridView__footer__expanderPadding-default_theme-default');
   });
});
