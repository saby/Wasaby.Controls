         ...
         describe('Template', function() {
            it('Hiding the native scroll', function() {
               ...
               assert.equal(result, '<div class="controls-Scroll ws-flexbox ws-flex-column">' +
                  '<span class="controls-Scroll__content controls-BlockLayout__blockGroup_theme-default controls-Scroll__content_hideNativeScrollbar controls-Scroll__content_hidden controls-StickyHeaderController">' +
               ...
               assert.equal(result, '<div class="controls-Scroll ws-flexbox ws-flex-column">' +
                  '<span class="controls-Scroll__content controls-BlockLayout__blockGroup_theme-default controls-Scroll__content_hideNativeScrollbar controls-StickyHeaderController" style="margin-right: -15px;">' +
                  '<div class="controls-Scroll__userContent">test</div>' +
                  '</span>' +
                  '<div></div>' +
                  '</div>');
