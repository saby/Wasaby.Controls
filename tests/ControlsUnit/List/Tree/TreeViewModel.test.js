         ...
         it('prepareExpanderClasses', function() {
            var
               ...
               testsResultPrepareExpanderClasses = [
                  'controls-TreeGrid__row-expander_theme-default controls-TreeGrid__row-expander_size_default_theme-default js-controls-ListView__notEditable controls-TreeGrid__row-expander_hiddenNode_default_theme-default controls-TreeGrid__row-expander_collapsed_theme-default controls-TreeGrid__row-expander_hiddenNode_default_collapsed_theme-default',
                  'controls-TreeGrid__row-expander_theme-default controls-TreeGrid__row-expander_size_default_theme-default js-controls-ListView__notEditable controls-TreeGrid__row-expander_testIcon_theme-default controls-TreeGrid__row-expander_collapsed_theme-default controls-TreeGrid__row-expander_testIcon_collapsed_theme-default',
                  'controls-TreeGrid__row-expander_theme-default controls-TreeGrid__row-expander_size_default_theme-default js-controls-ListView__notEditable controls-TreeGrid__row-expander_node_default_theme-default controls-TreeGrid__row-expander_collapsed_theme-default controls-TreeGrid__row-expander_node_default_collapsed_theme-default',
                  'controls-TreeGrid__row-expander_theme-default controls-TreeGrid__row-expander_size_default_theme-default js-controls-ListView__notEditable controls-TreeGrid__row-expander_testIcon_theme-default controls-TreeGrid__row-expander_collapsed_theme-default controls-TreeGrid__row-expander_testIcon_collapsed_theme-default',
                  'controls-TreeGrid__row-expander_theme-default controls-TreeGrid__row-expander_size_default_theme-default js-controls-ListView__notEditable controls-TreeGrid__row-expander_node_default_theme-default controls-TreeGrid__row-expander_collapsed_theme-default controls-TreeGrid__row-expander_node_default_collapsed_theme-default',
                  'controls-TreeGrid__row-expander_theme-default controls-TreeGrid__row-expander_size_default_theme-default js-controls-ListView__notEditable controls-TreeGrid__row-expander_hiddenNode_default_theme-default controls-TreeGrid__row-expander_collapsed_theme-default controls-TreeGrid__row-expander_hiddenNode_default_collapsed_theme-default'
               ];
