   ...
   describe('Controls.List.Grid.GridViewModel', function() {
      ...
      describe('"_private" block', function() {
            ...
            var
               testCases = [
                  ...
                  },
                  {
                     ...
                     resultData: 'LADDER_STYLE; grid-column: 2 / 3;'
                  },
                  {
                     inputData: {
                        itemData: {
         ...
         it('getCellStyle should set styles for partial support if has colspan', function () {
            ...
            assert.equal('', gridMod.GridViewModel._private.getCellStyle(itemData, currentColumn, true));

            currentColumn.columnIndex++;
            assert.equal(' grid-column: 2 / 4; -ms-grid-column: 2; -ms-grid-column-span: 2;',
         ...
         it('getPaddingCellClasses', function() {
            var
               ...
               expectedResultWithoutMultiselect = [
                  ' controls-Grid__cell_firstSpacingColumn_xl controls-Grid__cell_default controls-Grid__row-cell_rowSpacingTop_l controls-Grid__row-cell_rowSpacingBottom_l',
               ...
               expectedResultWithMultiselect = [
                  ' controls-Grid__cell_default controls-Grid__row-cell_rowSpacingTop_l controls-Grid__row-cell_rowSpacingBottom_l',
                  ' controls-Grid__cell_spacingRight controls-Grid__cell_default controls-Grid__row-cell_rowSpacingTop_l controls-Grid__row-cell_rowSpacingBottom_l',
                  ' controls-Grid__cell_spacingLeft controls-Grid__cell_spacingRight controls-Grid__cell_default controls-Grid__row-cell_rowSpacingTop_l controls-Grid__row-cell_rowSpacingBottom_l',
                  ' controls-Grid__cell_spacingLeft controls-Grid__cell_spacingLastCol_l controls-Grid__cell_default controls-Grid__row-cell_rowSpacingTop_l controls-Grid__row-cell_rowSpacingBottom_l',
                  ' controls-Grid__cell_spacingRight controls-Grid__cell_spacingBackButton_with_multiSelection controls-Grid__cell_default controls-Grid__row-cell_rowSpacingTop_l controls-Grid__row-cell_rowSpacingBottom_l'];
            ...
            assert.equal(expectedResultWithoutMultiselect[3],
                gridMod.GridViewModel._private.getPaddingHeaderCellClasses(cMerge(paramsWithoutMultiselect, {columnIndex: 3, rowIndex: 0})),
               'Incorrect value "GridViewModel._private.getPaddingCellClasses(paramsWithoutMultiselect)".');
            assert.equal(expectedResultWithoutMultiselect[4],
         ...
         it('getPaddingHeaderCellClasses for multiHeader', function() {
           ...
           */
            ...
            assert.equal(expectedResultRow[0],
                gridMod.GridViewModel._private.getPaddingHeaderCellClasses({...paramsForFirstRow, columnIndex: 0, rowIndex: 0, cell: paramsForFirstRow.columns[0]}),
                'Incorrect value "GridViewModel._private.getPaddingHeaderCellClasses()".');
            assert.equal(expectedResultRow[1],
                gridMod.GridViewModel._private.getPaddingHeaderCellClasses({...paramsForFirstRow, columnIndex: 1, rowIndex: 0, cell: paramsForFirstRow.columns[1]}),
                'Incorrect value "GridViewModel._private.getPaddingHeaderCellClasses()".');
            assert.equal(expectedResultRow[2],
                gridMod.GridViewModel._private.getPaddingHeaderCellClasses({...paramsForFirstRow, columnIndex: 2, rowIndex: 0, cell: paramsForFirstRow.columns[2]}),
                'Incorrect value "GridViewModel._private.getPaddingHeaderCellClasses()".');
            assert.equal(expectedResultRow[3],
                gridMod.GridViewModel._private.getPaddingHeaderCellClasses({...paramsForFirstRow, columnIndex: 3, rowIndex: 0, cell: paramsForFirstRow.columns[3]}),
                'Incorrect value "GridViewModel._private.getPaddingHeaderCellClasses()".');
            assert.equal(expectedResultRow[4],
                gridMod.GridViewModel._private.getPaddingHeaderCellClasses({...paramsForFirstRow, columnIndex: 4, rowIndex: 0, cell: paramsForFirstRow.columns[4]}),
                'Incorrect value "GridViewModel._private.getPaddingHeaderCellClasses()".');
            ...
            assert.equal(expectedResultRow[2],
                gridMod.GridViewModel._private.getPaddingHeaderCellClasses({...paramsForSecondRow, columnIndex: 0, rowIndex: 1, cell: paramsForSecondRow.columns[0]}),
                'Incorrect value "GridViewModel._private.getPaddingHeaderCellClasses()".');
            assert.equal(expectedResultRow[2],
                gridMod.GridViewModel._private.getPaddingHeaderCellClasses({...paramsForSecondRow, columnIndex: 1, rowIndex: 1, cell: paramsForSecondRow.columns[1]}),
                'Incorrect value "GridViewModel._private.getPaddingHeaderCellClasses()".');
         });
         ...
         it('prepareRowSeparatorClasses', function() {
            var
               expectedResultWithRowSeparator = [
                  ' controls-Grid__row-cell_firstRow controls-Grid__row-cell_withRowSeparator_firstRow controls-Grid__row-cell_withRowSeparator_notLastRow',
                  ' controls-Grid__row-cell_withRowSeparator controls-Grid__row-cell_withRowSeparator_notLastRow',
               ...
               expectedResultForFirstItemInGroup = ' controls-Grid__row-cell_first-row-in-group controls-Grid__row-cell_withRowSeparator_notLastRow',
               expectedResultForFirstItemInHiddenGroup = ' controls-Grid__row-cell_firstRow controls-Grid__row-cell_withRowSeparator_firstRow controls-Grid__row-cell_withRowSeparator_notLastRow',
            ...
            var
               ...
               expected = {
                  withMarker: 'controls-Grid__row-cell controls-Grid__cell_fit controls-Grid__row-cell-background-hover controls-Grid__row-cell_firstRow' +
                     ' controls-Grid__row-cell_withRowSeparator_firstRow controls-Grid__row-cell_withRowSeparator_notLastRow controls-Grid__row-cell-checkbox controls-Grid__row-cell_selected' +
         ...
         it('getItemColumnCellClasses', function() {
            var
               ...
               current = gridViewModel.getCurrent(),
               expectedResult = [
                  'controls-Grid__row-cell controls-Grid__cell_fit controls-Grid__row-cell-background-hover controls-Grid__row-cell_firstRow controls-Grid__row-cell_withRowSeparator_firstRow controls-Grid__row-cell_withRowSeparator_notLastRow' +
         ...
         it('columns', function() {
            ...
            checkBaseProperties(current.getCurrentColumn(), {
               ...
               cellClasses: 'controls-Grid__row-cell controls-Grid__cell_fit controls-Grid__row-cell-background-hover controls-Grid__row-cell_firstRow' +
                  ' controls-Grid__row-cell_withRowSeparator_firstRow controls-Grid__row-cell_withRowSeparator_notLastRow controls-Grid__row-cell-checkbox' +
                  ' controls-Grid__row-cell_selected controls-Grid__row-cell_selected-default' +
                  ' controls-Grid__row-cell_selected__first-default'
            });
            ...
            checkBaseProperties(current.getCurrentColumn(), {
               ...
               item: gridData[0],
               template: null,
               cellClasses: 'controls-Grid__row-cell controls-Grid__cell_fit controls-Grid__row-cell-background-hover controls-Grid__row-cell_firstRow controls-Grid__row-cell_withRowSeparator_firstRow controls-Grid__row-cell_withRowSeparator_notLastRow' +
               ' controls-Grid__cell_spacingRight controls-Grid__cell_default controls-Grid__row-cell_rowSpacingTop_l controls-Grid__row-cell_rowSpacingBottom_l ' +
               'controls-Grid__row-cell_selected controls-Grid__row-cell_selected-default'
            });
      ...
      describe('other methods of the class', function() {
         ...
         it('getCurrentHeaderColumn && goToNextHeaderColumn && isEndHeaderColumn && resetHeaderColumns', function() {
            ...
            assert.deepEqual({
               column: {title : '123'},
               cellClasses: 'controls-Grid__header-cell controls-Grid__header-cell_min-height controls-Grid__cell_default',
               index: 0,
               cellContentClasses: '',
               cellStyles: '',
         ...
         it('_prepareResultsColumns', function() {
            assert.deepEqual([{}].concat(gridColumns), gridViewModel._resultsColumns, 'Incorrect value "_headerColumns" before "_prepareResultsColumns([])".');
            gridViewModel._prepareResultsColumns([]);
            assert.deepEqual([{}], gridViewModel._resultsColumns, 'Incorrect value "_resultsColumns" after "_prepareResultsColumns([])".');
            gridViewModel._prepareResultsColumns(gridColumns);
            assert.deepEqual([{}, ...gridColumns], gridViewModel._resultsColumns, 'Incorrect value "_resultsColumns" after "_prepareResultsColumns(gridColumns)".');
         });
         ...
         it('getCurrentResultsColumn && goToNextResultsColumn && isEndResultsColumn && resetResultsColumns', function() {
          ...
          it('_prepareColgroupColumns', function() {
            ...
            assert.deepEqual([{
               ...
               style: '',
               index: 0
            }], gridViewModel._colgroupColumns, 'Incorrect value "_colgroupColumns" after "_prepareColgroupColumns([])" without multiselect.');
         ...
         it('getColspanStyles', function() {
            assert.equal(gridMod.GridViewModel._private.getColspanStyles('hidden', 0, 2), '');

            assert.equal(gridMod.GridViewModel._private.getColspanStyles('hidden', 1, 2), ' grid-column: 2 / 3;');

            // TODO: удалить isHeaderBreadCrumbs после https://online.sbis.ru/opendoc.html?guid=b3647c3e-ac44-489c-958f-12fe6118892f
            assert.equal(gridMod.GridViewModel._private.getColspanStyles('hidden', 0, 2, true), '');
            assert.equal(gridMod.GridViewModel._private.getColspanStyles('hidden', 1, 2, true), ' grid-column: 2 / 3;');

            assert.equal(gridMod.GridViewModel._private.getColspanStyles('visible', 0, 2), '');

            assert.equal(gridMod.GridViewModel._private.getColspanStyles('visible', 1, 2), ' grid-column: 2 / 3;');

            // TODO: удалить isHeaderBreadCrumbs после https://online.sbis.ru/opendoc.html?guid=b3647c3e-ac44-489c-958f-12fe6118892f
            assert.equal(gridMod.GridViewModel._private.getColspanStyles('visible', 1, 2, true), ' grid-column: 2 / 3;');
         });
      ...
      describe('partial grid support', () => {
         ...
         it('prepareItemDataForPartialSupport without multiSelection', function () {
            ...
            assert.equal(
                ...
                'display: grid; grid-template-columns: max-content 1fr 123px 321px; grid-column-start: 1; grid-column-end: 3; grid-row-start: 3; grid-row-end: 4;'
            );
         ...
         it('prepareItemDataForPartialSupport with multiSelection', function () {
            ...
            assert.equal(
                editingItemData.getEditingRowStyles(),
                'display: grid; grid-template-columns: max-content 1fr 123px 321px; grid-column-start: 1; grid-column-end: 5; grid-row-start: 3; grid-row-end: 4;'
            );
            assert.equal(groupItemData.gridGroupStyles, "grid-row: 3; -ms-grid-row: 3;");
         });
         ...
         describe('getEmptyTemplateStyles', () => {
            describe('IE', () => {
               ...
               it('no checkbox && has header && results in top', () => {
                  ...
                  assert.equal(
                      'grid-column-start: 2; grid-column-end: 6; -ms-grid-column: 2; -ms-grid-column-span: 4; grid-row-start: 3; grid-row-end: 4; -ms-grid-row: 3; -ms-grid-row-span: 1;',
               ...
               it('no checkbox && hasn\'t header && results in top', () => {
                  ...
                  model._options.resultsPosition = 'top';
                  assert.equal(
                      'grid-column-start: 2; grid-column-end: 6; -ms-grid-column: 2; -ms-grid-column-span: 4; grid-row-start: 2; grid-row-end: 3; -ms-grid-row: 2; -ms-grid-row-span: 1;',
                      model.getEmptyTemplateStyles()
                  );
               });
               ...
               it('no checkbox && hasn\'t header && results in bottom', () => {
                  ...
                  model._options.resultsPosition = 'bottom';
                  assert.equal(
                      'grid-column-start: 2; grid-column-end: 6; -ms-grid-column: 2; -ms-grid-column-span: 4; grid-row-start: 1; grid-row-end: 2; -ms-grid-row: 1; -ms-grid-row-span: 1;',
                      model.getEmptyTemplateStyles()
                  );
               });
            ...
            describe('other old browsers', () => {
               it('no checkbox && has header && results in top', () => {
                  ...
                  model._setHeader([{}]);
                  model._options.resultsPosition = 'top';
                  assert.equal('grid-column-start: 2; grid-column-end: 6; grid-row-start: 3; grid-row-end: 4;', model.getEmptyTemplateStyles());
               });
               it('has checkbox && has header && results in top', () => {
                  model.setMultiSelectVisibility('visible');
                  model._setHeader([{}]);
               ...
               it('no checkbox && hasn\'t header && results in top', () => {
                  ...
                  model._header = null;
                  model._options.resultsPosition = 'top';
                  assert.equal('grid-column-start: 2; grid-column-end: 6; grid-row-start: 2; grid-row-end: 3;', model.getEmptyTemplateStyles());
               });
               it('has checkbox && hasn\'t header && results in top', () => {
                  model.setMultiSelectVisibility('visible');
                  model._header = null;
               ...
               it('no checkbox && hasn\'t header && results in bottom', () => {
                  ...
                  model._header = null;
                  model._options.resultsPosition = 'bottom';
                  assert.equal('grid-column-start: 2; grid-column-end: 6; grid-row-start: 1; grid-row-end: 2;', model.getEmptyTemplateStyles());
               });
               it('has checkbox && hasn\'t header && results in bottom', () => {
                  model.setMultiSelectVisibility('visible');
                  model._header = null;
