...
define(
   [
      'Controls/_source/QueryParamsController/PagePaginationController',
      'Controls/_source/QueryParamsController/PositionPaginationController',
      'Types/collection',
      'Types/source'
   ],
   function (PagePaginationController,
             PositionPaginationController, collection, sourceLib) {
      ...
      describe('Controls.Controllers.QueryParamsController', function () {
         ...
         describe('Page', function () {
            it('init', function () {
               var pNav = new PagePaginationController.default({
                  page: 1,
                  pageSize: 4
               });
            ...
            it('validateNavigation', function () {
               ...
               pNav.destroy();
               pNav = new PagePaginationController.default({
                  page: 1,
                  pageSize: 4,
                  hasMore: false
               });
         ...
         describe('PositionPaginationController', function () {
            it('calculate state with first query', function () {
               var pNav = new PositionPaginationController.default({
                  field: 'field',
                  limit: 100,
                  direction: 'after',
                  position: 1
               ...
               pNav = new PositionPaginationController.default({
                  field: ['field', 'id'],
                  direction: 'both',
                  position: 1,
                  limit: 100
