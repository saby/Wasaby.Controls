define(['Controls/treeGrid',
   ...
   describe('Controls.List.TreeGrid.TreeGridViewModel', function() {
      ...
      it('getItemDataByItem', function() {
         ...
         assert.equal(currentColumn.classList.base, ' controls-TreeGrid__row-cell_theme-default controls-TreeGrid__row-cell-default_theme-default controls-TreeGrid__row-cell__item_theme-default');
