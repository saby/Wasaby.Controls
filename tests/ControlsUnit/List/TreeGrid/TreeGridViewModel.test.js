define(['Controls/treeGrid',
   ...
   describe('Controls.List.TreeGrid.TreeGridViewModel', function() {
      ...
      it('getCurrent', function () {
         ...
         assert.equal(currentColumn.getExpanderClasses('l', 'hiddenNode'), current.getExpanderClasses('l', 'hiddenNode'));
         model.goToNext();
      ...
      it('itemData and columnData should have same methods that use in expander template', function() {
         ...
         assert.equal(itemData.getExpanderClasses('l', 'hiddenNode'), columnData.getExpanderClasses('l', 'hiddenNode'));
