   ...
   describe('Controls/Date/Month/MonthModel', function() {
      ...
      describe('._isStateChanged', function() {
         let tests = [
            ...
            { hoveredRange: [new Date(2018, 0, 1), new Date(2018, 1, 1), [new Date(2017, 0, 4), new Date(2017, 0, 10)]], resp: true}б
            { hoveredRange: [new Date(2017, 1, 1), new Date(2017, 1, 10), [null, null]]}
         ];
