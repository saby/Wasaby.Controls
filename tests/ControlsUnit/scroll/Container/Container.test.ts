...
describe('Controls/scroll:Container', () => {
    ...
    describe('shadowMode', () => {
        [{
            ...
            isOptimizeShadowEnabledAfterMouseEnter: false,
            optimizeShadowClass: 'controls-Scroll__background-Shadow_style-default_theme-default controls-Scroll__background-Shadow_top-auto_bottom-auto_style-default_theme-default',
            optimizeShadowClassAfterMouseEnter: ''
        }, {
            ...
            optimizeShadowClass: 'controls-Scroll__background-Shadow_style-default_theme-default controls-Scroll__background-Shadow_top-auto_bottom-auto_style-default_theme-default',
            optimizeShadowClassAfterMouseEnter: 'controls-Scroll__background-Shadow_style-default_theme-default controls-Scroll__background-Shadow_top-auto_bottom-auto_style-default_theme-default'
        }].forEach((test) => {
            it(test.shadowMode, () => {
