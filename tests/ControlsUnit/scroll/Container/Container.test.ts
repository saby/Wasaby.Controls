...
describe('Controls/scroll:_ContainerNew', () => {
    describe('constructor', () => {
        it('should initialize by default', () => {
            ...
            assert.strictEqual(component._scrollCssClass, 'controls-Scroll-Container__base-userContent  controls-Scroll__content_hideNativeScrollbar controls-Scroll-ContainerBase__scroll_vertical');
        });
    });
    ...
    describe('_updateState', () => {
        ...
        it('should update _scrollCssClass, scrollMode: "verticalHorizontal"', () => { // controls-Scroll-ContainerBase__scroll_vertical
            ...
            component._scrollbars._scrollContainerStyles = '';
            component._updateState(state);
            assert.strictEqual(component._scrollCssClass, 'controls-Scroll-Container__base-userContent  controls-Scroll__content_hideNativeScrollbar controls-Scroll-ContainerBase__scroll_verticalHorizontal');
        });
    });
