      ...
      describe('openPopup', function() {
         it('should open opener with default options', function() {
            ...
            sinon.assert.calledWith(component._children.opener.open, sinon.match({
               className: 'controls-DatePopup__selector-marginTop_fontSize-medium_theme-default controls-DatePopup__selector-marginLeft_theme-default',
               target: TARGET,
               templateOptions: {
         ...
         describe('open dialog with .controls-DatePopup__selector-marginLeft-withoutModeBtn css class', function() {
            [{
               ...
               it(`${JSON.stringify(test)}`, function () {
                  ...
                  component.openPopup();
                  sinon.assert.calledWith(component._children.opener.open, sinon.match({
                     className: 'controls-DatePopup__selector-marginTop_fontSize-medium_theme-default controls-DatePopup__selector-marginLeft-withoutModeBtn_theme-default'
                  }));
               });
            });
         });
