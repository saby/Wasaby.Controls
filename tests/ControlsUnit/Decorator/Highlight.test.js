define(
   ...
   function(Env, ProxyCall, TemplateUtil, decorator, template1) {
      ...
      describe('Controls.Decorator.Highlight', function() {
         ...
         it('Value of parsedText without highlight', function() {
            var
               ...
               newOptions3 = {
                  value: 'value4',
                  highlightMode: 'word',
                  highlightedValue: 'v a l u e'
               };

            ctrl._beforeMount(options);

            assert.deepEqual([{type: 'plain', value: 'value1'}], ctrl._parsedText);

            ctrl._beforeUpdate(newOptions1);

            assert.deepEqual([{type: 'plain', value: 'value2'}], ctrl._parsedText);
            ...
            ctrl._beforeUpdate(newOptions3);

            assert.deepEqual([{type: 'plain', value: 'v a l u e'}], ctrl._parsedText);
         });
         ...
         describe('Parsed of the value.', function() {
            describe('Word search.', function() {
               it('The search word is not in the value.', function() {
                  ctrl._beforeMount({
               ...
               it('The search word is in the value.', function() {
                  ctrl._beforeMount({
                     value: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
            ...
            describe('Substring search.', function() {
               it('The search substring is not in the value.', function() {
                  ctrl._beforeMount({
                     value: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
               ...
               it('The search substring is in the value.', function() {
                  ctrl._beforeMount({
                     value: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
