gemini.suite('SBIS3.CONTROLS.ToggleButton Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_toggle_button_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('big', function (test) {
        ...
        test.setUrl('/regression_toggle_button_carry_4.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon16', function (test) {
        ...
        test.setUrl('/regression_toggle_button_carry_2.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon24', function (test) {
        ...
        test.setUrl('/regression_toggle_button_carry_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('big_with_icon16', function (test) {
        ...
        test.setUrl('/regression_toggle_button_carry_5.html').setCaptureElements('.capture')
    ...
    gemini.suite('big_with_icon24', function (test) {
        ...
        test.setUrl('/regression_toggle_button_carry_6.html').setCaptureElements('.capture')
