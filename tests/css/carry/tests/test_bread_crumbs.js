gemini.suite('SBIS3.CONTROLS.BreadCrumbs Carry', function () {
	
    gemini.suite('base', function (test) {

        test.setUrl('/regression_bread_crumbs_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('small_items', function (test) {
        ...
        test.setUrl('/regression_bread_crumbs_carry_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('dots', function (test) {
        ...
        test.setUrl('/regression_bread_crumbs_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('have_titles', function (test) {
        ...
        test.setUrl('/regression_engine_browser_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('have_titles_and_height_24', function (test) {
        ...
        test.setUrl('/regression_engine_browser_carry_3.html').setCaptureElements('.capture')
	...
	gemini.suite('have_titles_and_height_25', function (test) {
        ...
        test.setUrl('/regression_engine_browser_carry_4.html').setCaptureElements('.capture')
	...
	gemini.suite('have_no_titles', function (test) {
        ...
        test.setUrl('/regression_engine_browser_carry_5.html').setCaptureElements('.capture')
	...
	gemini.suite('have_notitles_and_height_24', function (test) {
        ...
        test.setUrl('/regression_engine_browser_carry_6.html').setCaptureElements('.capture')
	...
	gemini.suite('have_notitles_and_height_25', function (test) {
        ...
        test.setUrl('/regression_engine_browser_carry_7.html').setCaptureElements('.capture')
