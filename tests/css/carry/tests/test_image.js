gemini.suite('SBIS3.CONTROLS.Image Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_image_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('with_edit_dialog', function (test) {
        ...
        test.setUrl('/regression_image_carry_2.html').setCaptureElements('html')
	...
	gemini.suite('small_image', function (test) {
        ...
        test.setUrl('/regression_image_carry_3.html').setCaptureElements('.capture')
