gemini.suite('SBIS3.CONTROLS.BackButton Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_back_button_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('with_arrow', function (test) {
        ...
        test.setUrl('/regression_back_button_carry_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_empty_caption', function (test) {
        ...
        test.setUrl('/regression_back_button_carry_2.html').setCaptureElements('.capture')
