gemini.suite('SBIS3.CONTROLS.ProgressBar Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_progress_bar_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('left_align', function (test) {
        ...
        test.setUrl('/regression_progress_bar_carry_2.html').setCaptureElements('.capture')
    ...
    gemini.suite('right_align', function (test) {
        ...
        test.setUrl('/regression_progress_bar_carry_3.html').setCaptureElements('.capture')
