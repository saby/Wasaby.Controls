gemini.suite('SBIS3.CONTROLS.ItemsAction Carry', function () {
	
    gemini.suite('TreeCompositeViewTable', function (test) {

        test.setUrl('/regression_items_action_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('TreeCompositeViewList', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('TreeCompositeViewTile', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('CompositeViewTable', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_4.html').setCaptureElements('.capture')
	...
	gemini.suite('CompositeViewList', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_5.html').setCaptureElements('.capture')
	...
	gemini.suite('CompositeViewTile', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_6.html').setCaptureElements('.capture')
	...
	gemini.suite('DataGridView', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_7.html').setCaptureElements('.capture')
	...
	gemini.suite('DataGridView Hierarchy', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_24.html').setCaptureElements('html')
	...
	gemini.suite('TreeDataGridView', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_8.html').setCaptureElements('.capture')
	...
	gemini.suite('TreeDataGridView Hierarchy', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_25.html').setCaptureElements('html')
	...
	gemini.suite('TreeCompositeViewList SelectionOnItemClick', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_26.html').setCaptureElements('.capture')
	...
	gemini.suite('TreeDataGridView LongItemName', function (test) {
        ...
        test.setUrl('/regression_items_action_carry_27.html').setCaptureElements('.capture')
