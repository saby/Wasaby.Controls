gemini.suite('SBIS3.CONTROLS.Button Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_button_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('filled_base', function (test) {
        ...
        test.setUrl('/regression_button_carry_12.html').setCaptureElements('.capture')
    ...
    gemini.suite('big_base', function (test) {
        ...
        test.setUrl('/regression_button_carry_5.html').setCaptureElements('.capture')
    ...
    gemini.suite('filled_big_base', function (test) {
        ...
        test.setUrl('/regression_button_carry_13.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon16', function (test) {
        ...
        test.setUrl('/regression_button_carry_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('big_with_icon16', function (test) {
        ...
        test.setUrl('/regression_button_carry_7.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon24', function (test) {
        ...
        test.setUrl('/regression_button_carry_4.html').setCaptureElements('.capture')
    ...
    gemini.suite('big_with_icon24', function (test) {
        ...
        test.setUrl('/regression_button_carry_8.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_empty_caption', function (test) {
        ...
        test.setUrl('/regression_button_carry_2.html').setCaptureElements('[sbisname="Button 1"]')
    ...
    gemini.suite('ellipsis', function (test) {
        ...
        test.setUrl('/regression_button_carry_9.html').setCaptureElements('[sbisname="Button 1"]')
    ...
    gemini.suite('big_ellipsis', function (test) {
        ...
        test.setUrl('/regression_button_carry_11.html').setCaptureElements('[sbisname="Button 1"]')
