gemini.suite('SBIS3.CONTROLS.MenuLink Carry', function () {
	
	gemini.suite('base', function (test) {

        test.setUrl('/regression_menu_link_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('right_side', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry.html').setCaptureElements('html')
	...
	gemini.suite('base_and_half_items_have_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('base_and_half_items_have_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_4.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_6.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_9.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon24_and_half_itemt_have_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_10.html').setCaptureElements('.capture')
	...
	gemini.suite('with_base_with_submenu', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_15.html').setCaptureElements('.capture')
	...
	gemini.suite('right_side_with_submenu', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_15.html').setCaptureElements('html')
	...
	gemini.suite('with_submenu_icon16_and_half_items_have_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_17.html').setCaptureElements('.capture')
	...
	gemini.suite('with_submenu_and_item_icon24_half', function (test) {
        ...
        test.setUrl('/regression_menu_link_carry_20.html').setCaptureElements('.capture')
