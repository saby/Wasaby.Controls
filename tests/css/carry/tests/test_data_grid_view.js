gemini.suite('SBIS3.CONTROLS.DataGridView Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_data_grid_view_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('has_separator', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_6.html').setCaptureElements('.capture')
    ...
    gemini.suite('empty_data', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('empty_data_with_footer', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_7.html').setCaptureElements('.capture')
	...
	gemini.suite('ellipsis_column', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_4.html').setCaptureElements('.capture')
	...
	gemini.suite('with_part_scroll', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_5.html').setCaptureElements('html')
	...
	gemini.suite('data_grid_in_row', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_8.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_paging_and_pager_no_amout', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_10.html').setCaptureElements('.capture')
    ...
    gemini.suite('without_marker', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_9.html').setCaptureElements('.capture')
	...
	gemini.suite('marker_right', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_11.html').setCaptureElements('.capture')
     ...
     gemini.suite('empty_data_and_load_indicator', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_carry_12.html').setCaptureElements('.capture')
