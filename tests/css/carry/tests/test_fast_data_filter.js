gemini.suite('SBIS3.CONTROLS.FastDataFilter Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_fast_data_filter_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('multiselect', function (test) {
        ...
        test.setUrl('/regression_fast_data_filter_carry_2.html').setCaptureElements('.capture')
    ...
    gemini.suite('inline_filters', function (test) {
        ...
        test.setUrl('/regression_fast_data_filter_carry_3.html').setCaptureElements('.capture')
