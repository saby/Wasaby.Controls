gemini.suite('SBIS3.CONTROLS.Link Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_link_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon16', function (test) {
        ...
        test.setUrl('/regression_link_carry_2.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon24', function (test) {
        ...
        test.setUrl('/regression_link_carry_4.html').setCaptureElements('.capture')
    ...
    gemini.suite('ellipsis', function (test) {
        ...
        test.setUrl('/regression_link_carry_3.html').setCaptureElements('[name="Link 1"]')
