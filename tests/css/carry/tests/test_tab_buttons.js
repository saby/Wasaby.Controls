gemini.suite('SBIS3.CONTROLS.TabButtons Carry', function () {
	
    gemini.suite('base', function (test) {

        test.setUrl('/regression_tab_buttons_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('with_items_in_free_place', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_7.html').setCaptureElements('.capture')
	...
	gemini.suite('with_main_tab', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('with_main_tab_and_left_align', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_5.html').setCaptureElements('.capture')
    ...
    gemini.suite('left_align', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_3.html').setCaptureElements('.capture')
	...
	gemini.suite('with_menu_link', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_4.html').setCaptureElements('.capture')
	...
	gemini.suite('with_add_text_and_left_align', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_6.html').setCaptureElements('.capture')
	...
	gemini.suite('simple_view', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_8.html').setCaptureElements('.capture')
	...
	gemini.suite('simple_view_orange', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_9.html').setCaptureElements('.capture')
	...
	gemini.suite('simple_view_hidden', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_10.html').setCaptureElements('.capture')
	...
	gemini.suite('with_counters', function (test) {
        ...
        test.setUrl('/regression_tab_buttons_carry_11.html').setCaptureElements('.capture')
