gemini.suite('SBIS3.CONTROLS.FieldLink Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_field_link_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_multiselect', function (test) {
        ...
        test.setUrl('/regression_field_link_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('underline_item', function (test) {
        ...
        test.setUrl('/regression_field_link_carry_3.html').setCaptureElements('.capture')
	...
	gemini.suite('bold_item', function (test) {
        ...
        test.setUrl('/regression_field_link_carry_4.html').setCaptureElements('.capture')
	...
	gemini.suite('three_dict', function (test) {
        ...
        test.setUrl('/regression_field_link_carry_7.html').setCaptureElements('.capture')
	...
	gemini.suite('autocomlete', function (test) {
        ...
        test.setUrl('/regression_field_link_carry_8.html').setCaptureElements('html')
