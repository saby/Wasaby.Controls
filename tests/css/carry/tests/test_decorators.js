gemini.suite('SBIS3.CONTROLS.Decorators Carry', function () {

    gemini.suite('HighlightDecorator', function (test) {

        test.setUrl('/regression_decorators_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('ColorMarkDecorator', function (test) {
        ...
        test.setUrl('/regression_decorators_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('LadderDecorator', function (test) {
        ...
        test.setUrl('/regression_decorators_carry_3.html').setCaptureElements('.capture')
