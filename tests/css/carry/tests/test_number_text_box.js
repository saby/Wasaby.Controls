gemini.suite('SBIS3.CONTROLS.NumberTextBox Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_number_text_box_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('right_align', function (test) {
        ...
        test.setUrl('/regression_number_text_box_carry_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_arrows', function (test) {
        ...
        test.setUrl('/regression_number_text_box_carry_2.html').setCaptureElements('.capture')
