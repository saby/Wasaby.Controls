gemini.suite('SBIS3.CONTROLS.CompositeViewList Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_composite_view_list_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('empty_data', function (test) {
        ...
        test.setUrl('/regression_composite_view_list_carry_2.html').setCaptureElements('.capture')
