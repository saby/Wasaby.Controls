gemini.suite('SBIS3.CONTROLS.CheckBox Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_check_box_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('three_state', function (test) {
        ...
        test.setUrl('/regression_check_box_carry_2.html').setCaptureElements('.capture')
