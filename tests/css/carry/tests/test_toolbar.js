gemini.suite('SBIS3.CONTROLS.Toolbar Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_toolbar_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('with_link', function (test) {
        ...
        test.setUrl('/regression_toolbar_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('not_menu_button', function (test) {
        ...
        test.setUrl('/regression_toolbar_carry_3.html').setCaptureElements('.capture')
