gemini.suite('SBIS3.CONTROLS.CompositeViewTile Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_composite_view_tile_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('without_marker', function (test) {
        ...
        test.setUrl('/regression_composite_view_tile_carry_4.html').setCaptureElements('.capture')
	...
	gemini.suite('empty_data', function (test) {
        ...
        test.setUrl('/regression_composite_view_tile_carry_2.html').setCaptureElements('.capture')
