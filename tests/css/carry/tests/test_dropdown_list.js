gemini.suite('SBIS3.CONTROLS.DropdownList Carry', function () {	

	gemini.suite('single', function (test) {

        test.setUrl('/regression_dropdown_list_carry_6.html').setCaptureElements('.capture')
	...
	gemini.suite('show_selected_item_in_list', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_11.html').setCaptureElements('.capture')
	...
	gemini.suite('without_arrow', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_8.html').setCaptureElements('.capture')
	...
	gemini.suite('without_cross', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_9.html').setCaptureElements('.capture')
	...
	gemini.suite('link_style', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_10.html').setCaptureElements('.capture')
	...
	gemini.suite('multiselect', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_7.html').setCaptureElements('.capture')
	...
	gemini.suite('item_template', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_13.html').setCaptureElements('.capture')
    ...
    gemini.suite('ellipsis', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_15.html').setCaptureElements('.capture')
	...
	gemini.suite('single_with_more_link', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_16.html').setCaptureElements('.capture')
	...
	gemini.suite('multiselect_with_more_link', function (test) {
        ...
        test.setUrl('/regression_dropdown_list_carry_17.html').setCaptureElements('.capture')
