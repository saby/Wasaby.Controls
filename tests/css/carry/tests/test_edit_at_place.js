gemini.suite('SBIS3.CONTROLS.EditAtPlace Carry', function () {

	gemini.suite('group_float', function (test) {

        test.setUrl('/regression_edit_at_place_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('group', function (test) {
        ...
        test.setUrl('/regression_edit_at_place_carry_2.html').setCaptureElements('.capture')
	...
	gemini.suite('with_panel', function (test) {
        ...
        test.setUrl('/regression_edit_at_place_carry_3.html').setCaptureElements('.capture')
	...
	gemini.suite('with_tabs', function (test) {
        ...
        test.setUrl('/regression_edit_at_place_carry_4.html').setCaptureElements('.capture')
	...
	gemini.suite('with_tabs_date_range', function (test) {
        ...
        test.setUrl('/regression_edit_at_place_carry_5.html').setCaptureElements('.capture')
