gemini.suite('SBIS3.CONTROLS.IconButton Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_icon_button_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('round_border_plus', function (test) {
        ...
        test.setUrl('/regression_icon_button_carry_7.html').setCaptureElements('.capture')
    ...
    gemini.suite('round_border', function (test) {
        ...
        test.setUrl('/regression_icon_button_carry_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon24', function (test) {
        ...
        test.setUrl('/regression_icon_button_carry_4.html').setCaptureElements('.capture')
    ...
    gemini.suite('round_border_with_icon24', function (test) {
        ...
        test.setUrl('/regression_icon_button_carry_6.html').setCaptureElements('.capture')
