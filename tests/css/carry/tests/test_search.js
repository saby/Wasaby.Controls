gemini.suite('SBIS3.CONTROLS.Search Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_search_carry.html').setCaptureElements('.capture')
	...
	gemini.suite('expanded', function (test) {
        ...
        test.setUrl('/regression_search_carry_2.html').setCaptureElements('.capture')
