gemini.suite('SBIS3.CONTROLS.MonthPicker Carry', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_month_picker_carry.html').setCaptureElements('.capture')
    ...
    gemini.suite('only_year', function (test) {
        ...
        test.setUrl('/regression_month_picker_carry_2.html').setCaptureElements('.capture')
