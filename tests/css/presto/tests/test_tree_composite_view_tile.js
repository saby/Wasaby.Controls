gemini.suite('SBIS3.CONTROLS.TreeCompositeViewTile Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_tree_composite_view_tile_presto.html').setCaptureElements('.capture')
