gemini.suite('SBIS3.CONTROLS.TreeCompositeViewTable Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_tree_composite_view_table_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('empty_data', function (test) {
        ...
        test.setUrl('/regression_tree_composite_view_table_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('ellipsis_column', function (test) {
        ...
        test.setUrl('/regression_tree_composite_view_table_presto_4.html').setCaptureElements('.capture')
	...
	gemini.suite('ellipsis_column_and_arrow_handler', function (test) {
        ...
        test.setUrl('/regression_tree_composite_view_table_presto_5.html').setCaptureElements('.capture')
