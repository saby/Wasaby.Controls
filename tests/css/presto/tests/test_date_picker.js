gemini.suite('SBIS3.CONTROLS.DatePicker Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_date_picker_presto.html').setCaptureElements('html')
    ...
    gemini.suite('without_calendar_icon', function (test) {
        ...
        test.setUrl('/regression_date_picker_presto_2.html').setCaptureElements('.capture')
