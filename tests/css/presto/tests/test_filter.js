gemini.suite('SBIS3.CONTROLS.Filter Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_filter_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('with_filter_history', function (test) {
        ...
        test.setUrl('/regression_filter_presto_3.html').setCaptureElements('.capture')
	...
	gemini.suite('custom_templates', function (test) {
        ...
        test.setUrl('/regression_filter_presto_4.html').setCaptureElements('.capture')
