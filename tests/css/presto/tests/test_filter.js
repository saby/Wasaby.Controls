    ...
    gemini.suite('base', function (test) {
        ...
        test.setUrl('/regression_filter_online.html').setCaptureElements('.capture')
			...
			.capture('opened_filter', function (actions) {
				...
				actions.waitForElementToShow('[data-component="SBIS3.FilterButtonFilterContent"] > div:nth-child(2) a', 1000);
            })
	...
	gemini.suite('with_filter_history', function (test) {
        ...
        test.setUrl('/regression_filter_online_3.html').setCaptureElements('.capture')
			...
			.capture('one_item_in_history', function (actions, find) {
                actions.click(this.filter_line);
				actions.waitForElementToShow('[data-component="SBIS3.FilterButtonFilterContent3"] > div:nth-child(2)', 1000);
				actions.waitForElementToShow('[data-component="SBIS3.FilterButtonFilterContent3"] > div:nth-child(3)', 1000);
				actions.waitForElementToShow('[data-component="SBIS3.FilterButtonFilterContent3"] > div:nth-child(4)', 1000);
				actions.executeJS(function (window) {
	...
	gemini.suite('custom_templates', function (test) {
        ...
        test.setUrl('/regression_filter_online_4.html').setCaptureElements('.capture')
			...
			.capture('selected', function (actions, find) {
                actions.click(this.filter_line);
				actions.waitForElementToShow('[data-component="SBIS3.FilterButtonFilterContent4"] > div:nth-child(2)', 1000);
				actions.waitForElementToShow('[data-component="SBIS3.FilterButtonFilterContent4"] > div:nth-child(3)', 1000);
				actions.waitForElementToShow('[data-component="SBIS3.FilterButtonFilterContent4"] > div:nth-child(4)', 1000);
				actions.executeJS(function (window) {
                    window.$ws.single.ControlStorage.getByName('ComboBox 1').setSelectedKey(2);
                });
				this.apply_button = find('.controls__filter-button__apply-filter');
