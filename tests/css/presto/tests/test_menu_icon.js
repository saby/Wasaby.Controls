gemini.suite('SBIS3.CONTROLS.MenuIcon Presto', function () {
	
	gemini.suite('with_icon16', function (test) {

        test.setUrl('/regression_menu_icon_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('page_sides', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto.html').setCaptureElements('html')
	...
	gemini.suite('with_scroll', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_23.html').setCaptureElements('html')
	...
	gemini.suite('with_icon16_and_half_items_have_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_4.html').setCaptureElements('.capture')
	...
	gemini.suite('round_border_with_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_7.html').setCaptureElements('.capture')
	...
	gemini.suite('round_border_with_icon16_and_half_items_have_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_10.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon24_and_half_items_have_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_6.html').setCaptureElements('.capture')
	...
	gemini.suite('round_border_with_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_8.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon16_with_submenu', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_17.html').setCaptureElements('.capture')
	...
	gemini.suite('page_sides_with_submenu', function (test) {
        ...
        test.setUrl('/regression_menu_icon_presto_17.html').setCaptureElements('html')
