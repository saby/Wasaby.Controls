gemini.suite('SBIS3.CONTROLS.DataGridEditAtPlace Presto', function () {
	
	gemini.suite('row_template', function (test) {

        test.setUrl('/regression_data_grid_view_edit_at_place_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('text_area_in_editor', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_7.html').setCaptureElements('.capture')
    ...
    gemini.suite('rich_editor_in_editor', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_15.html').setCaptureElements('.capture')
	...
	gemini.suite('add_new_data_in_folder', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_5.html').setCaptureElements('.capture')
	...
	gemini.suite('column_template', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('row_template_another_toolbar', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_3.html').setCaptureElements('.capture')
	...
	gemini.suite('column_template_another_toolbar', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_4.html').setCaptureElements('.capture')
    ...
    gemini.suite('edit_at_place_and_multeselect_false', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_19.html').setCaptureElements('.capture')
	...
	gemini.suite('editor_with_combobox', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_11.html').setCaptureElements('.capture')
    ...
    gemini.suite('items_actions_on_column_template', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_13.html').setCaptureElements('html')
    ...
    gemini.suite('items_actions_on_column_template_and_round_border', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_20.html').setCaptureElements('html')
    ...
    gemini.suite('items_actions_on_column_template_2', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_edit_at_place_presto_14.html').setCaptureElements('html')
