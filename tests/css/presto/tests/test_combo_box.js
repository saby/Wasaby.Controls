gemini.suite('SBIS3.CONTROLS.ComboBox Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_combo_box_presto.html').setCaptureElements('.capture')
    ...
    gemini.suite('not_editable', function (test) {
        ...
        test.setUrl('/regression_combo_box_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('with_autocomplete', function (test) {
        ...
        test.setUrl('/regression_combo_box_presto_4.html').setCaptureElements('html')
