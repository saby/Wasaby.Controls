gemini.suite('SBIS3.CONTROLS.TreeCompositeViewList Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_tree_composite_view_list_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('empty_data', function (test) {
        ...
        test.setUrl('/regression_tree_composite_view_list_presto_2.html').setCaptureElements('.capture')
