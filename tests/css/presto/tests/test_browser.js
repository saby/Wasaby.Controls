...
gemini.suite('SBIS3.CONTROLS.Browser Online', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_browser_online.html').setCaptureElements('.capture')
            ...
            .before(function (actions, find) {
				...
				actions.waitForElementToShow('[name="browserOperationsPanelButton"]', 40000);
                this.open_panel = find('[name="browserOperationsPanelButton"]');
				...
				actions.waitForElementToShow('[name="browserFilter"]', 40000);
                this.filter = find('[name="browserFilter"] .controls__filterButton__filterLine-items span');
            })
