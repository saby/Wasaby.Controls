gemini.suite('SBIS3.CONTROLS.Link Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_link_presto.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon16', function (test) {
        ...
        test.setUrl('/regression_link_presto_2.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_icon24', function (test) {
        ...
        test.setUrl('/regression_link_presto_4.html').setCaptureElements('.capture')
    ...
    gemini.suite('ellipsis', function (test) {
        ...
        test.setUrl('/regression_link_presto_3.html').setCaptureElements('[name="Link 1"]')
