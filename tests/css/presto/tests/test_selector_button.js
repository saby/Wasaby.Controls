gemini.suite('SBIS3.CONTROLS.SelectorButton Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_selector_button_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('multiselect', function (test) {
        ...
        test.setUrl('/regression_selector_button_presto_2.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_max_width', function (test) {
        ...
        test.setUrl('/regression_selector_button_presto_3.html').setCaptureElements('.capture')
