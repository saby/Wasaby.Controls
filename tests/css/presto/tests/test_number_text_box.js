gemini.suite('SBIS3.CONTROLS.NumberTextBox Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_number_text_box_presto.html').setCaptureElements('.capture')
    ...
    gemini.suite('right_align', function (test) {
        ...
        test.setUrl('/regression_number_text_box_presto_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_arrows', function (test) {
        ...
        test.setUrl('/regression_number_text_box_presto_2.html').setCaptureElements('.capture')
