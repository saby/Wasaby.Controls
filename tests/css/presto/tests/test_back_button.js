gemini.suite('SBIS3.CONTROLS.BackButton Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_back_button_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('with_arrow', function (test) {
        ...
        test.setUrl('/regression_back_button_presto_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_empty_caption', function (test) {
        ...
        test.setUrl('/regression_back_button_presto_2.html').setCaptureElements('.capture')
