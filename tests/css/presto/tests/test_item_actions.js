gemini.suite('SBIS3.CONTROLS.ItemsAction Presto', function () {
	
    gemini.suite('TreeCompositeViewTable', function (test) {

        test.setUrl('/regression_items_action_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('TreeCompositeViewList', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('TreeCompositeViewTile', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('CompositeViewTable', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_4.html').setCaptureElements('.capture')
	...
	gemini.suite('CompositeViewList', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_5.html').setCaptureElements('.capture')
	...
	gemini.suite('CompositeViewTile', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_6.html').setCaptureElements('.capture')
	...
	gemini.suite('DataGridView', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_7.html').setCaptureElements('.capture')
	...
	gemini.suite('DataGridView Hierarchy', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_24.html').setCaptureElements('html')
	...
	gemini.suite('TreeDataGridView', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_8.html').setCaptureElements('.capture')
	...
	gemini.suite('TreeDataGridView Hierarchy', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_25.html').setCaptureElements('html')
	...
	gemini.suite('TreeCompositeViewList SelectionOnItemClick', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_26.html').setCaptureElements('.capture')
	...
	gemini.suite('TreeDataGridView LongItemName', function (test) {
        ...
        test.setUrl('/regression_items_action_presto_27.html').setCaptureElements('.capture')
