gemini.suite('SBIS3.CONTROLS.TreeDataGridView Presto', function () {
	
    gemini.suite('base', function (test) {

        test.setUrl('/regression_tree_data_grid_view_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('with_edit_arrow', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_11.html').setCaptureElements('.capture')
	...
	gemini.suite('has_separator', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_9.html').setCaptureElements('.capture')
	...
	gemini.suite('cell_template', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_6.html').setCaptureElements('.capture')
    ...
    gemini.suite('empty_data', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('empty_data_with_footer', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_10.html').setCaptureElements('.capture')
	...
	gemini.suite('ellipsis_column', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_4.html').setCaptureElements('.capture')
	...
	gemini.suite('ellipsis_column_and_arrow_handler', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_5.html').setCaptureElements('.capture')
	...
	gemini.suite('with_part_scroll', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_7.html').setCaptureElements('html')
	...
	gemini.suite('group_by', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_8.html').setCaptureElements('.capture')
	...
	gemini.suite('with_folder_footer_template', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_12.html').setCaptureElements('.capture')
	...
	gemini.suite('with_cell_template_and_float_left', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_13.html').setCaptureElements('.capture')
	...
	gemini.suite('with_cell_template_and_image', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_14.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_hidden_row', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_15.html').setCaptureElements('.capture')
	...
	gemini.suite('ellipsis_and_long_text_with_arrow', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_19.html').setCaptureElements('.capture')
	...
	gemini.suite('load_more', function (test) {
        ...
        test.setUrl('/regression_tree_data_grid_view_presto_18.html').setCaptureElements('.capture')
