gemini.suite('SBIS3.CONTROLS.RadioGroup Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_radio_group_presto.html').setCaptureElements('.capture')
    ...
    gemini.suite('primary', function (test) {
        ...
        test.setUrl('/regression_radio_group_presto_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('vertical', function (test) {
        ...
        test.setUrl('/regression_radio_group_presto_2.html').setCaptureElements('.capture')
    ...
    gemini.suite('primary_vertical', function (test) {
        ...
        test.setUrl('/regression_radio_group_presto_4.html').setCaptureElements('.capture')
