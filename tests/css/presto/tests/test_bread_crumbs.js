gemini.suite('SBIS3.CONTROLS.BreadCrumbs Presto', function () {
	
    gemini.suite('base', function (test) {

        test.setUrl('/regression_bread_crumbs_presto.html').setCaptureElements('.capture')
    ...
    gemini.suite('small_items', function (test) {
        ...
        test.setUrl('/regression_bread_crumbs_presto_3.html').setCaptureElements('.capture')
    ...
    gemini.suite('dots', function (test) {
        ...
        test.setUrl('/regression_bread_crumbs_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('have_titles', function (test) {
        ...
        test.setUrl('/regression_engine_browser_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('have_titles_and_height_24', function (test) {
        ...
        test.setUrl('/regression_engine_browser_presto_3.html').setCaptureElements('.capture')
	...
	gemini.suite('have_titles_and_height_25', function (test) {
        ...
        test.setUrl('/regression_engine_browser_presto_4.html').setCaptureElements('.capture')
	...
	gemini.suite('have_no_titles', function (test) {
        ...
        test.setUrl('/regression_engine_browser_presto_5.html').setCaptureElements('.capture')
	...
	gemini.suite('have_notitles_and_height_24', function (test) {
        ...
        test.setUrl('/regression_engine_browser_presto_6.html').setCaptureElements('.capture')
	...
	gemini.suite('have_notitles_and_height_25', function (test) {
        ...
        test.setUrl('/regression_engine_browser_presto_7.html').setCaptureElements('.capture')
