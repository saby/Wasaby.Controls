gemini.suite('SBIS3.CONTROLS.TextArea Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_text_area_presto.html').setCaptureElements('.capture')
    ...
    gemini.suite('set_min_lines_count', function (test) {
        ...
        test.setUrl('/regression_text_area_presto_4.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_autoheight', function (test) {
        ...
        test.setUrl('/regression_text_area_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('with_min_lines_count', function (test) {
        ...
        test.setUrl('/regression_text_area_presto_3.html').setCaptureElements('.capture')
