gemini.suite('SBIS3.CONTROLS.MergeDialogs Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_merge_dialog_presto.html').setCaptureElements('html')
	...
	gemini.suite('with_custom_template', function (test) {
        ...
        test.setUrl('/regression_merge_dialog_presto_2.html').setCaptureElements('html')
