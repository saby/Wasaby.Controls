gemini.suite('SBIS3.CONTROLS.MenuButton Presto', function () {
	
    gemini.suite('base', function (test) {

        test.setUrl('/regression_menu_button_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('right_side', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto.html').setCaptureElements('html')
	...
	gemini.suite('base_and_half_items_have_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_8.html').setCaptureElements('.capture')
	...
	gemini.suite('base_and_half_items_have_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_10.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_3.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_5.html').setCaptureElements('.capture')
	...
	gemini.suite('with_icon24_and_half_items_have_icon24', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_14.html').setCaptureElements('.capture')
	...
	gemini.suite('base_with_submenu', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_15.html').setCaptureElements('.capture')
	...
	gemini.suite('page_sides_with_submenu', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_15.html').setCaptureElements('html')
	...
	gemini.suite('with_submenu_and_half_items_have_icon16', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_17.html').setCaptureElements('.capture')
	...
	gemini.suite('with_picker_class_name', function (test) {
        ...
        test.setUrl('/regression_menu_button_presto_23.html').setCaptureElements('.capture')
