gemini.suite('SBIS3.CONTROLS.SwitcherDouble Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_switcher_double_presto.html').setCaptureElements('.capture')
    ...
    gemini.suite('vertical', function (test) {
        ...
        test.setUrl('/regression_switcher_double_presto_2.html').setCaptureElements('.capture')
    ...
    gemini.suite('primary', function (test) {
        ...
        test.setUrl('/regression_switcher_double_presto_3.html').setCaptureElements('.capture')
