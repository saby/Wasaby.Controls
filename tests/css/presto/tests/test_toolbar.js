gemini.suite('SBIS3.CONTROLS.Toolbar Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_toolbar_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('with_link', function (test) {
        ...
        test.setUrl('/regression_toolbar_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('not_menu_button', function (test) {
        ...
        test.setUrl('/regression_toolbar_presto_3.html').setCaptureElements('.capture')
