gemini.suite('SBIS3.CONTROLS.MoveDialog Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_move_dialog_presto.html').setCaptureElements('body')
	...
	gemini.suite('folder_with_and_without_arrow', function (test) {
        ...
        test.setUrl('/regression_move_dialog_presto_2.html').setCaptureElements('body')
    ...
    gemini.suite('with_ellipsis', function (test) {
        ...
        test.setUrl('/regression_move_dialog_presto_3.html').setCaptureElements('body')
