gemini.suite('SBIS3.CONTROLS.CompositeViewTable Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_composite_view_table_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('empty_data', function (test) {
        ...
        test.setUrl('/regression_composite_view_table_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('ellipsis_column', function (test) {
        ...
        test.setUrl('/regression_composite_view_table_presto_4.html').setCaptureElements('.capture')
