gemini.suite('SBIS3.CONTROLS.DataGridView Presto', function () {

    gemini.suite('base', function (test) {

        test.setUrl('/regression_data_grid_view_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('has_separator', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_6.html').setCaptureElements('.capture')
    ...
    gemini.suite('empty_data', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_2.html').setCaptureElements('.capture')
	...
	gemini.suite('empty_data_with_footer', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_7.html').setCaptureElements('.capture')
	...
	gemini.suite('ellipsis_column', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_4.html').setCaptureElements('.capture')
	...
	gemini.suite('with_part_scroll', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_5.html').setCaptureElements('html')
	...
	gemini.suite('data_grid_in_row', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_8.html').setCaptureElements('.capture')
    ...
    gemini.suite('with_paging_and_pager_no_amout', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_10.html').setCaptureElements('.capture')
    ...
    gemini.suite('without_marker', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_9.html').setCaptureElements('.capture')
	...
	gemini.suite('marker_right', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_11.html').setCaptureElements('.capture')
     ...
     gemini.suite('empty_data_and_load_indicator', function (test) {
        ...
        test.setUrl('/regression_data_grid_view_presto_12.html').setCaptureElements('.capture')
