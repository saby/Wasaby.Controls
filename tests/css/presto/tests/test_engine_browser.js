gemini.suite('SBIS3.ENGINE.Browser Presto', function () {
	
    gemini.suite('base', function (test) {

        test.setUrl('/regression_engine_browser_presto.html').setCaptureElements('.capture')
	...
	gemini.suite('lonf_filter_text', function (test) {
        ...
        test.setUrl('/regression_engine_browser_presto_8.html').setCaptureElements('.controls-Browser__table-fullFilterBlock')
	...
	gemini.suite('back_button_editing', function (test) {
        ...
        test.setUrl('/regression_engine_browser_presto_8.html').setCaptureElements('html')
