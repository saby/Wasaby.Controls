define('Controls/Popup/Templates/Stack/StackTemplateStyles', [],
   ...
   /**
     ...
     * @css @min-height_StackTemplate-head   Min height of header
     * @css @background-color_StackTemplate-head       Background color of header
     * @css @size_StackTemplate-border-bottom       Size of border bottom
     * @css @color_StackTemplate-border-bottom       Color of border bottom
     * @css @spacing_StackTemplate-head                Spacing between heading and border
     * @css @spacing_StackTemplate-head_withMaximizedButton         Spacing between heading and border with maximized button
     * @css @spacing_StackTemplate-between-close-button-content     Spacing between close button and content
     * @css @spacing_StackTemplate-between-maximized-button-content-top  Spacing between maximized button and content on top
     * @css @spacing_StackTemplate-between-maximized-button-content-right  Spacing between maximized button and content on right
     *
