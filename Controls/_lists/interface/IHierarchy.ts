 ...
 *
 * @interface Controls/_lists/interface/IHierarchy
 * @public
 * @author Авраменко А.С.
 */

/**
 * @name Controls/_lists/interface/IHierarchy#nodeProperty
...
/**
 * @name Controls/_lists/interface/IHierarchy#parentProperty
