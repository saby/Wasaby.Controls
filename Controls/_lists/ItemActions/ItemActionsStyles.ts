 ...
 *
 * @css @icon-size_ItemActions-editAtPlace-applyButton Icon of apply button in edit at place mode.
 ...
 * @css @background-color_ItemActions-editAtPlace-applyButton Background color of apply button in edit at place mode.
 * @css @background-color_ItemActions-editAtPlace-applyButton_hovered Background color of hovered apply button in edit at place mode.
 * @css @background-color_ItemActions-editAtPlace-applyButton_active Background color of active apply button in edit at place mode.
 * @css @color_ItemActions-editAtPlace-applyButton Color of apply button icon in edit at place mode.
 * @css @color_ItemActions-editAtPlace-applyButton_hovered Color of apply hovered button icon in edit at place mode.
 * @css @color_ItemActions-editAtPlace-applyButton_active Color of apply active button icon in edit at place mode.
 * @css @border-color_ItemActions-editAtPlace-applyButton Border color of apply button in edit at place mode.
 * @css @border-color_ItemActions-editAtPlace-applyButton_hovered Border color of hovered apply button in edit at place mode.
 * @css @border-color_ItemActions-editAtPlace-applyButton_active Border color of active apply button in edit at place mode.
 * @css @text-shadow_ItemActions-editAtPlace-applyButton Text shadow of apply button icon in edit at place mode.
 * @css @text-shadow_ItemActions-editAtPlace-applyButton_hovered Text shadow of hovered apply button icon in edit at place mode.
 * @css @text-shadow_ItemActions-editAtPlace-applyButton_active Text shadow of active apply button icon in edit at place mode.
 * @css @icon-size_ItemActions-editAtPlace-closeButton Icon of close button in edit at place mode.
 ...
 * @css @background-color_ItemActions-editAtPlace-closeButton Background color of close button in edit at place mode.
 * @css @background-color_ItemActions-editAtPlace-closeButton_hovered Background color of hovered close button in edit at place mode.
 * @css @background-color_ItemActions-editAtPlace-closeButton_active Background color of active close button in edit at place mode.
 * @css @color_ItemActions-editAtPlace-closeButton Color of close button icon in edit at place mode.
 * @css @color_ItemActions-editAtPlace-closeButton_hovered Color of hovered close button icon in edit at place mode.
 * @css @color_ItemActions-editAtPlace-closeButton_active Color of active close button icon in edit at place mode.
 * @css @text-shadow_ItemActions-editAtPlace-closeButton Text shadow of close button icon in edit at place mode.
 * @css @text-shadow_ItemActions-editAtPlace-closeButton_hovered Text shadow of hovered close button icon in edit at place mode.
 * @css @text-shadow_ItemActions-editAtPlace-closeButton_active Text shadow of active close button icon in edit at place mode.
 */
