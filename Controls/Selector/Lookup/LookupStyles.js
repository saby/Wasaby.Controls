define('Controls/Selector/Lookup/LookupStyles', function() {}
    ...
    * @author Капустин И.А.
    *
    * @css @spacing_Lookup-multiLine-between-inputRenderWrapper-rightBorder Spacing between input render wrapper and right border in multiple selection mode.
    * @css @line-height_Lookup-input-wrapper Input wrapper line height.
    * @css @font-size_Lookup_showSelector The size of the button that opens the directory.
    ...
    * @css @color_Lookup-showSelector-hovered The color of the button when the hover that opens the directory.
    * @css @font-size_Lookup_clearRecords The size of the button that clears all selected entries.
