 ...
 * Отличается от события {@link /docs/js/Controls/interface/IDraggable/events/dragStart/ dragStart}, которое срабатывает у контейнера, из которого началось перемещение записи.
 * @example
