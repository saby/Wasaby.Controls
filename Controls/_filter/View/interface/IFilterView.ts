 ...
 * По умолчанию строится {@link Controls/dateRange:LiteSelector}. Для изменения шаблона редактора используйте editorTemplateName
 ...
 * В настоящей версии фреймворка поддерживается только для фильтра с type = 'dateRange'.
 */
