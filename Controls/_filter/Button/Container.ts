/**
 * Контрол используют в качестве контейнера для {Controls/filter:Selector}. Он обеспечивает передачу параметров фильтрации между {@link Controls/filter:Controller} и Controls/filter:Selector.
 * @remark
