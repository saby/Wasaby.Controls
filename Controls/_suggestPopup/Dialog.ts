...
import 'Controls/popupTemplate';
      ...
      /**
       * Контрол-контейнер. Он обеспечивает связь поля ввода и списка внутри выпадающего блока.
       * Он используется при создании шаблона для автодополнения и организации выпадающего списка.
       * Списочный контрол который отображает данные, должен быть обёрнут в этот контейнер.
       * @example
       * JavaScript
       * <pre class="brush: js">
