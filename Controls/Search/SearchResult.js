 ...
 */
define('Controls/Search/SearchResult',
   [
      'Core/Control',
      'tmpl!Controls/Search/SearchResult/SearchResult',
   ...
   function(Control, template, Memory, SearchController) {
      ...
      var _private = {
         ...
         setSourceBySearchResult: function(self, data) {
         ...
         searchCallback: function(self, result, filter) {
            _private.setSourceBySearchResult(self, result);
            self._filter = filter;
            self._forceUpdate();
         }
      };
      ...
      var SearchResult = Control.extend({
         ...
         _searchValueChanged: function(event, value) {
            this._searchController.setValue(value);
         }
