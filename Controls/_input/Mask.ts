...
import {spaceToLongSpace} from 'Controls/_input/Mask/Space';
       ...
       * Обычный символ - символ добавляющийся автоматически, по мере ввода.
       ...
       * Для того, чтобы показать обычные символы сразу, нужно настроить замену специальных символов на {@link replacer обычный символ}: " ", "_", "*" и т.п.
