...
import {spaceToLongSpace} from 'Controls/_input/Mask/Space';
       ...
       * Маска состоит из обычных и {@link formatMaskChars специальных символов}.
       ...
       * Видимость формата маски регулируется с значением опции. Если значение не пустое, то формат виден, иначе скрыт.
       * @example
       * <pre>
