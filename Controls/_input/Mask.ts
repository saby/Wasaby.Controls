...
import {spaceToLongSpace} from 'Controls/_input/Mask/Space';
      ...
      /**
       * Контрол для ввода значения с заданным форматом. Формат определяется {@link mask маской}. Маска состоит из обычных и {@link formatMaskChars специальных символов}.
       ...
       * По умолчанию формат значения показывается по мере заполнения контрола пользователем. Показать формат можно сразу. Для этого нужно настроить замену специальных символов на {@link replacer обычный символ}: " ", "_", "*" и т.п.
