...
import {spaceToLongSpace} from 'Controls/_input/Mask/Space';
       ...
       * Обычные символы - символ используемого алфавита.
       * Специальный символ - множество обычных символов. Например: d - Цифровой символ, l - Буквенный символ в нижнем регистре.
       ...
       * Каждому специальному символу маски, по мере ввода, ставятся в соответствии введенные символы. Обычные символы добавляются в поле автоматически. Для того, чтобы показать обычные символы сразу, нужно настроить замену специальных символов на {@link replacer обычный символ}: " ", "_", "*" и т.п.
       * Контрол с изначально видимыми обычные символы имеет автоширину по контенту. Задать свою ширину можно через css.
