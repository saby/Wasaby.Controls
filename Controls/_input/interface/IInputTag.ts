 ...
 *
 * @interface Controls/_input/interface/IInputTag
 * @public
 * @author Журавлев М.С.
 */

/**
 * @name Controls/_input/interface/IInputTag#tagStyle
...
/**
 * @event Controls/_input/interface/IInputTag#tagClick Occurs when tag was clicked.
...
/**
 * @event Controls/_input/interface/IInputTag#tagHover Occurs when tag is hovered.
 * @param {Object} event Native event object. Can be used to get target (DOM node of the tag) to show Infobox.
 * @remark The event will never fire unless you specify tagStyle option on the field.
 * @example
