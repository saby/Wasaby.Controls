...
/**
 * Базовое универсальное поле ввода даты и времени. Позволяет вводить дату и время одновременно или по отдельности. Контрол используется там, где реализовываются простые сценарии без платформенной возможности ввода дат мышкой.
 * @remark
