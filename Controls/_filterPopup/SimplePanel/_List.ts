...
import DropdownViewModel = require('Controls/_filterPopup/SimplePanel/DropdownViewModel');
...
var _private = {
    isNeedUpdateSelectedKeys: function(self, target, item) {
        var clickOnEmptyItem = item.get(self._options.keyProperty) === self._options.emptyKey,
            clickOnCheckBox = target.closest('.controls-SimplePanel-List__row-checkbox'),
