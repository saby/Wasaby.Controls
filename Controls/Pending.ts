...
import ParallelDeferred = require('Core/ParallelDeferred');
   ...
   /**
    * Контрол (HOC), контролирующий выполнение необходимых действий, которые должны быть завершены до начала текущего действия.
    ...
    * Controls/Pending имеет собственный LoadingIndicator, который может отображаться во время ожидания завершения. Этот LoadingIndicator имеет параметры по умолчанию.
