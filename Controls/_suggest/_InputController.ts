...
export default class InputContainer extends Control<IInputControllerOptions> {
   ...
   private async _resolveLoad(value?: string, options?: IInputControllerOptions): Promise<RecordSet | void> {
      ...
      if (value) {
         ...
         return (await this._getSearchController()).search(value).then((recordSet) => {
            ...
            if (recordSet instanceof RecordSet && this._shouldShowSuggest(recordSet) && (this._inputActive || this._tabsSelectedKey !== null || this._options.task1180696709)) {
   ...
   private _performLoad(options?: IInputControllerOptions): Promise<RecordSet | void> {
      ...
      return this._getSourceController(scopeOptions).load().then((recordSet) => {
         if (recordSet instanceof RecordSet && this._shouldShowSuggest(recordSet) && (this._inputActive || this._tabsSelectedKey !== null || scopeOptions.task1180696709)) {
            this._setItems(recordSet);
