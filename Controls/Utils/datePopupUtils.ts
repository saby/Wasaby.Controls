export default {
    ...
    getTemplateOptions: function(self) {
        return {
            startValue: self._rangeModel?.startValue || self._options.startValue || self._options.value[0],
            endValue: self._rangeModel?.endValue || self._options.endValue || self._options.value[1],
