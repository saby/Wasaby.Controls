/**
 * Интерфейс для контрола с возможностью группировки элементов.
 *
 ...
 * @cfg {Function} Функция, которая возвращает идентификатор группы.
 * @example
 * TMPL:
 * <pre>
 ...
 *    -  showText - задает стиль отображения имени группы.
