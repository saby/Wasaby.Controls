...
/**
    ...
    * @css @shift-left_MenuButton-link_medium-popup Offset on the left for pop-up at the menu with link viewMode and medium icon size.
    * @css @shift-top_MenuButton-link_duplicate_medium-popup Offset on the top for pop-up at the menu with the duplication of the icon next to the first element,
    * link viewMode and medium icon size.
    * @css @shift-left_MenuButton-link_duplicate_medium-popup Offset on the left for pop-up at the menu with the duplication of the icon next to the first element,
    * link viewMode and medium icon size.
    * @css @shift-top_MenuButton-link_duplicate_small-popup Offset on the top for pop-up at the menu with the duplication of the icon next to the first element,
    * link viewMode and medium icon size.
    * @css @shift-left_MenuButton-link_duplicate_small-popup Offset on the left for pop-up at the menu with the duplication of the icon next to the first element,
