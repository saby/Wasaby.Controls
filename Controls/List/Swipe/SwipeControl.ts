...
import * as template from 'wml!Controls/List/Swipe/SwipeControl';
...
import { IItemData, IListModel } from '../interface/IListViewModel';

const MEASURER_NAMES: Record<SwipeDirection, string> = {
   row: 'Controls/List/Swipe/HorizontalMeasurer',
   column: 'Controls/List/Swipe/VerticalMeasurer'
};
