define('Controls/List/Grid/GridStyles', ['Controls/_grids/GridStyles'], function(Control) {
/**
 * @author Родионов Е.А.
 ...
 * @css @background-color_Grid-item_editing background color of editing grid row
 * @css @border-color_Grid-firstRow-separator color of row separator (top border) in first row
