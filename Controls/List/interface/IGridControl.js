define('Controls/List/interface/IGridControl', [], function() {
    ...
    * @property {VerticalItemPaddingEnum} [top] Padding to the top border of the item.
    * @property {VerticalItemPaddingEnum} [bottom] Padding to the bottom border of the item.
    * @property {HorizontalItemPaddingEnum} [left] Padding to the left border of the grid.
    * @property {HorizontalItemPaddingEnum} [right] Padding to the right border of the grid.
    */

   /**
    * @cfg {ItemPadding} Padding to the borders in grid items.
