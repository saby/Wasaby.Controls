 ...
 *
 * @remark
 * Для предотвращения скачков текста при переключении из режима редактирования в режим чтения используйте css-класс
 * controls-Input_negativeOffset_theme_{{_options.theme}} на редактирумой области.
 *
