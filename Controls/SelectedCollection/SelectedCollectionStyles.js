define('Controls/SelectedCollection/SelectedCollectionStyles', [],
    ...
    * @css @border-width_SelectedCollection-popup Border width of pop-up.
    * @css @padding_SelectedCollection-popup Padding of pop-up.
    * @css @margin-top_SelectedCollection-popup Offset on the top for pop-up.
    * @css @margin-left_SelectedCollection-popup Offset on the left for pop-up.
    */
);
