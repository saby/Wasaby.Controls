define('Controls/interface/IGroupedList', [
    ...
    *    <li>expanderVisibility (тип Boolean | enum('hidden'|'right'|'left')) — видимость и расположение кнопки-экспандера, позволяющей сворачивать/разворачивать группу. Стандартное расположение - слева.</li>
