...
define('Controls/interface/IGroupedList', [
    ...
    * @remark
    * Элементы списка могут отображаться в группе без заголовка. Подробнее читайте <a href="https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/list/grouping/hidden/">здесь</a>.
    * @see groupTemplate
    * @see collapsedGroups
    * @see groupHistoryId
    * @see groupExpanded
