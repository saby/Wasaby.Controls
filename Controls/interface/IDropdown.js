define('Controls/interface/IDropdown', [], function() {
   ...
   /**
    * @name Controls/interface/IDropdown#dropDownAutofocus
    * @cfg {Boolean} Определяет, установится ли фокус на выпадающий список после его открытия.
    * @default true
    * @example
    * WML:
    * <pre>
   ...
   /*
    * @name Controls/interface/IDropdown#dropDownAutofocus
    * @cfg {Boolean} Determines whether autofocus on drop-down list after its opening.
    * @default true
    * @example
    * WML:
    * <pre>
