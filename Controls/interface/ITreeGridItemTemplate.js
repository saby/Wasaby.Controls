...
define('Controls/interface/ITreeGridItemTemplate', [
    ...
    *
    * Дополнительно о работе с шаблоном вы можете прочитать в {@link /doc/platform/developmentapl/interface-development/controls/list/tree/templates/item/ руководстве разработчика}.
    * @example
