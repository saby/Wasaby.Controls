...
define('Controls/interface/IEditableList', [
    ...
    * При этом базовая логика сохранения не используется, и поэтому вся ответственность за сохранение изменений перекладывается на прикладного разработчика.
    * Отметим, что событие {@link afterEndEdit} произойдет после срабатывания всех deferred, добавленных для события {@link beforeEndEdit}.
    */
