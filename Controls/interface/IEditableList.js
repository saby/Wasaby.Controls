...
define('Controls/interface/IEditableList', [
    ...
    * @param {Vdom/Vdom:SyntheticEvent} eventObject Дескриптор события.
    * @param {Types/entity:Model} item Редактируемый элемент.
    * @param {Boolean} willSave Параметр принимает значение true, когда изменения сохраняются в редактируемом элементе.
    ...
    * @param {Types/entity:Model} item Редактируемый элемент.
    * @param {Boolean} isAdd 
    * Параметр принимает значение true, когда элемент {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/list/edit/add/ добавляется по месту}.
    * @remark
