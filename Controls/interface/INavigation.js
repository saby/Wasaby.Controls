define('Controls/interface/INavigation', [
    ...
    * @variant maxCount Подгружать данные, пока не будет достигут порог, указанный в {@link NavigationViewConfig#}.
    */
    ...
    * </ul>
    * @property maxCountValue Кол-во записей, когда необходимо прекратить загрузку.
    */
