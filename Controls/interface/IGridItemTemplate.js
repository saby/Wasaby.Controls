...
define('Controls/interface/IGridItemTemplate', [
    ...
    *
    * Дополнительно о работе с шаблоном вы можете прочитать в {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/grid/item/ руководстве разработчика}.
    * @example
    ...
    * @cfg {String|undefined} Имя поля элемента, которое содержит имя шаблона. С помощью этой настройки отдельным элементам можно задать {@link Controls/interface/IGridItemTemplate#itemTemplate пользовательский шаблон отображения элемента}.
    * @default undefined
    * @remark
