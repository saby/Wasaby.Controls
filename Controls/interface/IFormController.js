...
define('Controls/interface/IFormController', [
    ...
    * @cfg {Function} Функция, которая определяет должно ли показаться окно с подтверждением сохранения. Нужно для случаев, когда есть данные, не связанные с рекордом.
