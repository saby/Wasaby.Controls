...
export interface IItemActionsOptions {
     ...
     * Подробнее о работе с опциями записи читайте {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/ здесь}.
     ...
     * @cfg {Controls/_itemActions/interface/IItemAction/TItemActionsPosition.typedef} Позиционирование панели с {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/position/ опциями записи}.
     * @remark
     * Подробнее о работе с опциями записи читайте {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/ здесь}.
     * Пример использования значения custom можно посмотреть в {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/actions-position/position-class/#custom статье}.
     ...
     * @remark Подробнее о работе с опциями записи читайте {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/ здесь}.
     */
     ...
     * @cfg {String} CSS класс, позволяющий задать отступы и позицию панели с {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/ опциями записи} внутри элемента.
...
/**
 * @event Происходит при клике по {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/ опции записи}.
