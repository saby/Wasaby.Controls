...
export interface IItemActionsTemplateConfig {
     ...
     * @cfg {Controls/itemActions:TActionAlignment} Варианты расположения опций внутри панели {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/ опций записи}
     */
    /*
     * @name Controls/_itemActions/itemActions/interface/IItemActionsTemplateConfig#actionAlignment
     ...
     * @cfg {String} CSS класс, позволяющий задать отступы и позицию панели с {@link https://wi.sbis.ru/doc/platform/developmentapl/interface-development/controls/list/item-actions/handler/ опциями записи} внутри элемента.
