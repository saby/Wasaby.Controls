...
class MenuControl extends Control<IMenuControlOptions> implements IMenuControl {
    ...
    protected _itemActionClick(event: SyntheticEvent<MouseEvent>, item: CollectionItem<Model>, action: object, clickEvent: MouseEvent): void {
    ...
    private _calculateActionsConfig(listModel: Collection<Model>, options: IMenuControlOptions): void {
