...
class MasterDetail extends Control<IMasterDetail> {
    /**
     * @name Controls/_masterDetail/Base#master
     * @cfg {Function} Шаблон контентной области, отображающейся в левой части.
     */

    /**
     * @name Controls/_masterDetail/Base#detail
     * @cfg {Function} Шаблон контентной области, отображающейся в правой части.
     */
