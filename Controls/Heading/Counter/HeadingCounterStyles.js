define('Controls/Heading/Counter/HeadingCounterStyles',
    ...
    * @css @font-size_Counter_size-m Medium text size.
    * @css @font-size_Counter_size-l Large text size.
    *
    * @css @color_Counter_style-primary Default text color.
    * @css @color_Counter_style-secondary Primary text color.
    * @css @color_Counter_style-disabled Disabled text color.
    *
