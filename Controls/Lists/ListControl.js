define('js!Controls/Lists/ListControl', [
   'Core/core-extend',
   'Core/Control',
   'tmpl!Controls/Lists/ListControl',
   'js!Controls/Lists/resources/utils/DataSourceUtil',
   ...
   var ListView = Control.extend(
      {
         _controlName: 'Controls/Lists/ListControl',
