 ...
 *
 * @interface Controls/_treeGrids/interface/ITreeControl
 * @public
...
/**
 * @name Controls/_treeGrids/interface/ITreeControl#expandedItems
...
/**
 * @name Controls/_treeGrids/interface/ITreeControl#collapsedItems
 * @cfg {Boolean} Array of identifiers of collapsed items.
 * This option is used only when the value of  {@link Controls/_treeGrids/interface/ITreeControl#expandedItems expandedItems} is [null].
 * <a href="/materials/demo-ws4-tree-grid-base">Example</a>.
 */

/**
 * @name Controls/_treeGrids/interface/ITreeControl#nodeFooterTemplate
...
/**
 * @name Controls/_treeGrids/interface/ITreeControl#hasChildrenProperty
 * @cfg {String} Name of the field that contains information whether the node has children.
 * <a href="/materials/demo-ws4-tree-grid-extended">Example</a>.
 */

/**
 * @name Controls/_treeGrids/interface/ITreeControl#expanderVisibility
...
/**
 * @event Controls/_treeGrids/interface/ITreeControl#itemExpanded Occurs after node expansion.
 */
/**
 * @event Controls/_treeGrids/interface/ITreeControl#itemCollapsed Occurs after node collapse.
 */
