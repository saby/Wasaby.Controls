...
/**
 * Опции интерфейса описаны {@link Controls/_popup/interface/IEditOpener}.
 * @public
 ...
 * * "stack" — смотреть {@link Controls/popup:IStackOpener.PopupOptions}
 * * "dialog" — смотреть {@link Controls/popup:IDialogOpener.PopupOptions}
 * * "sticky" — смотреть {@link Controls/popup:IStickyOpener.PopupOptions}
 * @returns {undefined}
 * @example
