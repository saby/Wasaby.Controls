...
/**
 * @typedef {Object} Controls/_popup/interface/IEdit/AdditionalData
 ...
 * @param {Controls/_popup/interface/IEdit/AdditionalData.typedef} additionalData Дополнительные данные, переданные из formController.
 */
