define('js!Controls/Input/resources/TextRender/TextRender',
   [
      'Core/Control',
      'tmpl!Controls/Input/resources/TextRender/TextRender',
      'js!Controls/Input/resources/SelectionUtil',
      'js!Controls/Input/resources/CalcInputValue'
   ],
   function(Control, template, SelectionUtil, CalcInputValue) {
      ...
      var TextBoxRender = Control.extend({
          ...
          *
          * @name Controls.Input.resources.TextRender.TextRender#getInputData
          ...
          *
          *
          * @name Controls.Input.resources.TextRender.TextRender#value
          * @cfg {String} Значение поля.
          *
          * @name Controls.Input.resources.TextRender.TextRender#tagStyle
          ...
          * @variant info #999999.
          *
          * @name Controls.Input.resources.TextRender.TextRender#placeholder
          * @cfg {String} Устанавливает текст подсказки внутри поля ввода.
          *
          * @name Controls.Input.resources.TextRender.TextRender#selectOnClick
          ...
          */
         _controlName: 'Controls/Input/resources/TextRender/TextRender',
