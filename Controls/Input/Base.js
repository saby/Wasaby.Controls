define('Controls/Input/Base',
   ...
   function(
      ...
      var _private = {
         ...
         isTriggeredChangeEventByEnterKey: function(self) {
            /**
             * Change event is generated by pressing enter key only of <input>.
             * For other elements, such as <textarea>, this does not happen.
             * https://jsfiddle.net/q13864xa/
             */
            return self._getField().tagName === 'INPUT';
         },
      ...
      var Base = Control.extend({
         ...
         _keyUpHandler: function(event) {
            ...
            if (keyCode === constants.key.enter && _private.isTriggeredChangeEventByEnterKey(this)) {
