/// <amd-module name="Controls/File/ResourceGetter/PhotoCam/DialogAbstract" />
define("Controls/File/ResourceGetter/PhotoCam/DialogAbstract", ["require", "exports", "SBIS3.CONTROLS/CompoundControl", "Core/Deferred", "Controls/File/LocalFile", "Controls/File/LocalFileLink", "tmpl!Controls/File/ResourceGetter/PhotoCam/Dialog", "SBIS3.CONTROLS/WaitIndicator", "SBIS3.CONTROLS/Button", "css!Controls/File/ResourceGetter/PhotoCam/Dialog"], function (require, exports, CompoundControl, Deferred, LocalFile, LocalFileLink, tmpl, WaitIndicator) {
    "use strict";
    ...
    var DialogAbstract = CompoundControl.extend({
        ...
        init: function () {
            ...
            setTimeout(function () {
                ...
                if (!_this.isDestroyed()) {
                    var parent_1 = _this.getParent();
                    parent_1 && parent_1.show();
                }
            }, BEFORE_SHOW_DELAY);
        ...
        /**
         * Возвращает {@link Controls/File/IFileData} по переданному параметру
         * @param {File | Blob | string} image
         * @return {Controls/File/LocalFile | Controls/File/LocalFileLink}
         * @private
         */
        _prepareFile: function (image) {
            if (image instanceof Blob) {
                var name_1 = "imageFromCamera.png";
                // для корректной загрузки Blob необходимо имя файла
                image.name = name_1;
                image.lastModifiedDate = new Date();
                return new LocalFile(image, {}, name_1);
            }
