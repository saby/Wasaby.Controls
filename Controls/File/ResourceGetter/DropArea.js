/// <amd-module name="Controls/File/ResourceGetter/DropArea" />
/// <amd-dependency path="css!Controls/File/ResourceGetter/DropArea" />
define("Controls/File/ResourceGetter/DropArea", ["require", "exports", "tslib", "Controls/File/ResourceGetter/Base", "Core/Deferred", "Core/helpers/random-helpers", "Controls/File/utils/ExtensionsHelper", "css!Controls/File/ResourceGetter/DropArea"], function (require, exports, tslib_1, IResourceGetterBase, Deferred, random, ExtensionsHelper) {
    "use strict";
    ...
    var OPTION = {
         ...
         * @name Controls/File/ResourceGetter/DropArea#dropText
         */
        dropText: rk("Отпустите файлы"),
        /**
         * @cfg {String} Класс внутреннего элемента обёртки, содержащий текст
         * @name Controls/File/ResourceGetter/DropArea#innerClass
         */
        innerClass: null
    };
    /**
     ...
     * @class
     * @name Controls/File/ResourceGetter/DropArea
     * @extends Controls/File/IResourceGetter
     * @public
     * @author Заляев А.В.
     */
    var DropArea = /** @class */ (function (_super) {
         ...
         * @method
         * @name Controls/File/ResourceGetter/DropArea#getFiles
         ...
         * @method
         * @name Controls/File/ResourceGetter/DropArea#canExec
         */
