/// <amd-module name="Controls/File/utils/ExtensionsHelper" />
define("Controls/File/utils/ExtensionsHelper", ["require", "exports", "json!Controls/File/utils/MimeTypes", "json!Controls/File/utils/MediaTypes", "Controls/File/LocalFile", "Controls/File/utils/ExtensionsError"], function (require, exports, MimeTypes, MediaTypes, LocalFile, ExtensionsError) {
    "use strict";
    ...
    var ExtensionsHelper = /** @class */ (function () {
        ...
        /**
         * Проверяет валидность файлов переданного FileList и заменяет их на {@link Controls/File/LocalFile} либо на объект ошибки
