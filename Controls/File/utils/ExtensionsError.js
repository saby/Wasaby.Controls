/// <amd-module name="Controls/File/utils/ExtensionsError" />
define("Controls/File/utils/ExtensionsError", ["require", "exports", "tslib"], function (require, exports, tslib_1) {
    "use strict";
    var DEFAULT_MESSAGE = rk('Выбранный файл неверного типа');
    /**
     * @cfg {String} Имя файла, вызвавшего ошибку
     * @name Controls/File/utils/ExtensionsError#fileName
     */
    /**
     * Ошибка несоответствия типа выбранного файла
     * @class
     * @name Controls/File/utils/ExtensionsError
     * @public
     * @extends Error
     */
