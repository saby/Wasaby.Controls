define("Controls/File/LocalFile", ["require", "exports"], function (require, exports) {
    "use strict";
    /// <amd-module name="Controls/File/LocalFile" />
    /**
     * Класс - обёртка над нативным File/Blob
     * @class
     * @name Controls/File/LocalFile
     * @public
     * @author Заляев А.В.
     */
    var LocalFile = /** @class */ (function () {
         ...
         * Возвращает файл
         * @return {File | Blob}
         * @name Controls/File/LocalFile#getData
         * @method
         */
         ...
         * @return {*}
         * @name Controls/File/LocalFile#getMeta
         * @method
         */
