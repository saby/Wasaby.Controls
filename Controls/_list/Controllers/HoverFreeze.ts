...
export default class HoverFreeze {
     ...
     * В гридах для установки фона нужно перебить два селектора, т.к. в списках фон берётся из свойств самой записи,
     * а в гридах - из cell (ячейка) и cell__content (контент ячейки).
