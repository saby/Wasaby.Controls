...
const ListViewModel = ItemsViewModel.extend([entityLib.VersionableMixin], {
    ...
    getItemDataByItem: function() {
        ...
        const itemPadding = _private.getItemPadding(this._options.itemPadding);
        if (itemPadding.top === 'null' && itemPadding.bottom === 'null') {
            itemsModelCurrent.defaultPadding = `controls-ListView_default-padding_theme-${theme}`;
        } else {
            itemsModelCurrent.defaultPadding = '';
        }
