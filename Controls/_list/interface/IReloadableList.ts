 ...
 * Принимает опционально {@link Controls/_interface/INavigation/IBaseSourceConfig.typedef конфигурация источника данных }, если нужно перезагрузить список с навигацией, отличной от указанной в опциях контрола.
 * @function
