 ...
 *
 * @interface Controls/_lists/interface/IVirtualScroll
 * @public
 * @author Родионов Е.А.
 */

/**
 * @name Controls/_lists/interface/IVirtualScroll#virtualScrolling
...
/**
 * @name Controls/_lists/interface/IVirtualScroll#virtualPageSize
 ...
 *     <li>S - number of items that will be inserted/removed on reaching the end of displayed items({@link Controls/_lists/interface/IVirtualScroll#virtualSegmentSize virtualSegmentSize}).</li>
 * </ul>
 * <b>Note for Controls/Grid:View</b>: the value of the virtualPageSize should be less then 1000/total columns count in grid.
 */

/**
 * @name Controls/_lists/interface/IVirtualScroll#virtualSegmentSize
 * @cfg {Number} Number of items that will be inserted/removed on reaching the end of displayed items.
 * @default 20
 */

/**
 * @name Controls/_lists/interface/IVirtualScroll#startIndex
 * @cfg {Number} The index of the first item displayed in the list at initializing.
 * @default 0
 */

/**
 * @name Controls/_lists/interface/IVirtualScroll#updateItemsHeightsMode
