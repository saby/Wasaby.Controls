 ...
 * @cfg {IVirtualScrollConfig} Конфигурация виртуального скроллинга. Виртуальный скроллинг работает только при включенной {@link /doc/platform/controls/list/list/navigation/ навигации}.
 */
