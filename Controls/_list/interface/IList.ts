 ...
 * @variant enabled Чекбокс виден и с ним можно взаимодействовать.
 * @variant disabled Чекбокс виден, но с ним нельзя взаимодействовать.
 * @variant hidden Чекбокс скрыт.
