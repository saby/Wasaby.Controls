 ...
 * Функция возвращает {Controls/display:TColspanCallbackResult} - количество объединяемых колонок, учитывая текущую. Для объединения всех колонок из функции нужно вернуть специальное значение 'all'
 * @markdown
 */
