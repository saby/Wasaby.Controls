 ...
 * В качестве значения свойства можно указать пиксели (px), проценты (%), доли (1fr), "auto", "minmax", "min-content" и "max-content".
 ...
 * В значении "max-content" ширина устанавливается автоматически в зависимости от самого большого элемента в колонке. Например, если в первой строке ширина контента 100px, а во второй строке — 200px, тогда ширина колонки будет определена как 200px.
 * В значении "min-content" ширина устанавливается автоматически в зависимости от самого маленького элемента в колонке. Например, если в первой строке ширина контента 100px, а во второй строке — 200px, тогда ширина колонки будет определена как 100px.
