 ...
 * Он обеспечивает связь между {@link Controls/_search/Input/Container Controls/search:Controller} и {@link Controls/_list/Container Controls/list:Container} — контейнерами для строки поиска и списочного контрола соответветственно. 
