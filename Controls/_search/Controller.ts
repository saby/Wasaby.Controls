 ...
 * С помощью этого контрола можно настроить:
 * временную задержку между вводом символа и началом поиска,
 * количество символов, с которых начинается поиск, 
 * параметры фильтрации и другое.
 *
