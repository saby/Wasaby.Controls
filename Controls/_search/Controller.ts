 ...
 * Он обеспечивает связь между {@link Controls/_search/Input/Container} и {@link Controls/_list/Container} — контейнерами для строки поиска и списочного контрола соответветственно. 
