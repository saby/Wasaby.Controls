 ...
 * @css @color_Lookup-showSelector_hovered The color of the button when the hover that opens the directory.
 * @css @color_Lookup-showSelector_active The color of the button when the activeted that opens the directory.
 * @css @font-size_Lookup-clearRecords The size of the button that clears all selected entries.
 ...
 * @css @color_Lookup-clearRecords_hovered The color of the button when the hover that clears all selected entries.
