...
export interface IToolbarOptions extends IControlOptions, IHierarchyOptions, IIconSizeOptions,
     ...
     * который задействуется первый раз по ховеру над кнопкой выпадающего меню.
     * Это требуется когда нужно лениво вычислить пункты меню перед непосредственным открытием выпадающего меню,
