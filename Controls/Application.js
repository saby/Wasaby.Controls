...
define('Controls/Application',
    ...
    * @cfg {Content} Список JS-файлов, который должны быть подключены на страницу. Скрипты встраиваются перед закрытием. Могут принимать более одного корневого узла.
    */
