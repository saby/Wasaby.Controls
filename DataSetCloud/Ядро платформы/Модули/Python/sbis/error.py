...
class Error( Exception ):
   ...
   def __init__( self, details, user_msg = "", error_code = -1, type = ExceptionType.ERROR ):
...
class Warning( Error ):
   ...
   def __init__( self, details, user_msg = "", error_code = -1 ):
      super().__init__( details, user_msg, error_code, ExceptionType.WARNING )
...
class SerializableException( Error ):
   ...
   def __init__( self, details, user_msg = "", error_code = -1, class_uuid = None, type = ExceptionType.ERROR, passed_exception = None ):
      "Конструктор исключения"
      super().__init__( details, user_msg, error_code, type )
...
class KeyboardInterrupt( Error ):
   "Исключение прерывания с клавиатуры"
   pass
