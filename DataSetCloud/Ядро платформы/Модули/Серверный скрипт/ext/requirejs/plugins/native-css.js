...
define("native-css", ['normalize'], function(normalize) {
  ...
  if (engine == 'trident' && hackLinks) {
    ...
    var ieLoadNextImport = function(style) {
      ...
      var curSheet = style.styleSheet || style.sheet;
  ...
  cssAPI.inject = function(css) {
    ...
    } else if (curStyle.sheet) {
      curStyle.sheet.cssText += css;
    } else
  ...
  if (testing)
    cssAPI.inspect = function() {
      if (stylesheet.styleSheet)
        ...
        return stylesheet.sheet.cssText;
