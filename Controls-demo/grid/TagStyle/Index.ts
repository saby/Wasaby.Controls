...
import * as template from 'wml!Controls-demo/grid/TagStyle/TagStyle';
...
export default class TagStyleGridDemo extends Control<IControlOptions> {
    ...
    private _getModifiedData(): any {
        ...
        const reverseStyleVariants = [...styleVariants].reverse();
        return getCountriesStats().getData().map((cur, i) => {
            ...
            return {
                ...
                customProperty: reverseStyleVariants[index]
            };
        });
    }
}
