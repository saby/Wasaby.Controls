...
import controlTemplate = require('wml!Controls-demo/Scroll/Shadow/Template');
...
class Previewer extends Control<IControlOptions> {
    ...
    static _styles: string[] = ['Controls-demo/InfoBox/resources/InfoboxButtonHelp', 'Controls-demo/Scroll/Shadow/Style', 'Controls-demo/Controls-demo'];
}
