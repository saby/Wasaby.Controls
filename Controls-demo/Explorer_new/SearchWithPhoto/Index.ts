...
import * as Template from 'wml!Controls-demo/Explorer_new/SearchWithPhoto/SearchWithPhoto';
...
export default class extends Control {
   ...
   static _styles: string[] = ['Controls-demo/Controls-demo', 'Controls-demo/Explorer_new/SearchWithPhoto/styles'];
}
