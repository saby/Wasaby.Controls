...
class DemoControl extends Control<IControlOptions> {
    ...
    protected _endValue1: Date = new Date(2020, 0, 0);
    ...
    protected _endValue3: Date = new Date(2020, 0, 0);
    protected _startValue4: Date = new Date(2020, 0);
    protected _endValue4: Date = new Date(2020, 0, 0);
    protected _startValue5: Date = new Date(2020, 0);
    protected _endValue5: Date = new Date(2020, 0, 0);
