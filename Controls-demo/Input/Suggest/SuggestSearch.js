define('Controls-demo/Input/Suggest/SuggestSearch', [
   'Core/Control',
   'tmpl!Controls-demo/Input/Suggest/SuggestSearch',
   ...
   var VDomSuggest = Control.extend({
      ...
      _kindsOfBox: function() {
         return new MemorySource({
            idProperty: 'id',
            data: this._itemTpl
         });
      },
      _props: function() { //displayProperty
         return new MemorySource({
            idProperty: 'title',
      ...
      constructor: function() {
         ...
         this._secondSource = new MemorySource({
            idProperty: 'id',
            filter: function(record, filter) {
               if (record.get('title').indexOf(filter.title) !== -1) {
                  return true;
