define('Controls-demo/List/NavigationSwitching', [
   ...
   var ModuleClass = BaseControl.extend(
      {
         _template: template,
         _styles: ['Controls-demo/List/NavigationSwitching/NavigationSwitching'],
         _navigationMode: '',
         _pageSize: null,
         ...
         _switchNavigation: function(e) {
            this._navigationMode = this._navigationMode === "pages" ? 'infinity' : "pages";
            this._pageSize = this._navigationMode === "pages" ? 4 : 10;
         }
