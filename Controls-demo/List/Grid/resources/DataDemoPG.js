define('Controls-demo/List/Grid/resources/DataDemoPG', ['Env/Env', 'Controls-demo/resources/Images'],
    function(Env, DemoImages) {
        var showType = {
          ...
          firstItemActionsArray: [
             {
                ...
                handler: function(item) {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Like it)', item);
                }
             },
             {
                id: 2,
                ...
                title: 'Dislike it',
                handler: function(item) {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Dislike it)', item);
                }
             },
             {
                id: 3,
                ...
                showType: showType.TOOLBAR,
                handler: function(item) {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Add to favorite)', item);
                }
             },
             {
                id: 7,
                ...
                handler: function() {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Remove from list)');
                }
             },
             {
                id: 4,
                ...
                'parent@': true,
                handler: function() {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Actors)', item);
                }
             },
             {
                id: 5,
                ...
                'parent@': false,
                handler: function() {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Show all)', item);
                }
             },
             {
                id: 6,
                ...
                'parent@': false,
                handler: function() {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(More films with same actors)', item);
                }
             }
          ],
          secondItemActionsArray: [
             {
                ...
                handler: function(item) {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Attach file)', item);
                }
             },
             {
                id: 2,
                ...
                'parent@': true,
                handler: function(item) {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Edit film)', item);
                }
             },
             {
                id: 3,
                ...
                showType: showType.MENU,
                handler: function(item) {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Edit description)', item);
                }
             },
             {
                id: 4,
                ...
                'parent@': false,
                handler: function(item) {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Edit media)', item);
                }
             },
             {
                id: 5,
                ...
                showType: showType.MENU_TOOLBAR,
                handler: function() {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Hide)');
                }
             },
             {
                id: 6,
                ...
                showType: showType.MENU,
                handler: function() {
                   Env.IoC.resolve('ILogger').info('itemActionsClick(Delete)');
                }
             }
          ]
       };
