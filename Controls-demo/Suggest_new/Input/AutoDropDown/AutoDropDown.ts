...
import controlTemplate = require('wml!Controls-demo/Suggest_new/Input/AutoDropDown/AutoDropDown');
import suggestTemplate = require('wml!Controls-demo/Suggest_new/Input/AutoDropDown/resources/SuggestTemplate');
