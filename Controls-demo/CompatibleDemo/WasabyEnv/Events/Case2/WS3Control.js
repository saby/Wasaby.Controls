define('Controls-demo/CompatibleDemo/WasabyEnv/Events/Case2/WS3Control', [
   'Lib/Control/CompoundControl/CompoundControl',
   'tmpl!Controls-demo/CompatibleDemo/WasabyEnv/Events/Case2/WS3Control'
   ...
   var WS3Control = CompoundControl.extend({
      ...
      init: function(opts) {
         ...
         require(['Controls-demo/CompatibleDemo/WasabyEnv/Events/Case2/WasabyControl'], function(WasabyControl) {
