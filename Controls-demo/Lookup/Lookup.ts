...
import {getNavigation, getSuggestSourceLong} from 'Controls-demo/Lookup/DemoHelpers/DataCatalog';
...
export default class extends Control{
   ...
   protected _beforeMount() {
      this._suggestTemplate = 'wml!Controls-demo/Lookup/resources/SuggestTemplate';
