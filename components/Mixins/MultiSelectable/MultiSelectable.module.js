define('js!SBIS3.CONTROLS.MultiSelectable', ['js!SBIS3.CONTROLS.Data.Collection.List'], function(List) {
   ...
   var MultiSelectable = /**@lends SBIS3.CONTROLS.MultiSelectable.prototype  */{
      ...
      $protected: {
         _options: {
            /**
             * @cfg {Boolean} Устанавливает режим множественного выбора.
             * @variant true множественный выбор установлен
             * @variant false множественный выбор отменен
             * @remark
             * Возможность выбора нескольких значений из списка для последующего одновременного выполнения определенной
             * последовательности операций с выбранными значениями.
             * При включенном множественном выборе записи всегда добавляются, а не замещают предыдущий выбор.
             * Режим множественного выбора работает независимо от
