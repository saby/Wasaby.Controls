      ...
      $protected: {
         ...
         _options: {
            ...
            dataSource: undefined,
              ...
              * В базе данных как листья, так и узлы являются записями. Поэтому необходимо учитывать, что в
             ...
             * @property {String} field Поле по которому нужно сгруппировать записи.
             * @property {Function} method Функция, которая определяет необходимость отрисовки перед текущей записью заголовка группы.
