   ...
   var DSMixin = /**@lends SBIS3.CONTROLS.DSMixin.prototype  */{
      ...
      $protected: {
         ...
         _options: {
             ...
             * @remark
             * Ключевое поле используется для определения элементов коллекции и последующей работы с ними.
             ...
             * В поле связи используется для отображения значений поля для всех выбранных записей.
