   ...
   var DSMixin = /**@lends SBIS3.CONTROLS.DSMixin.prototype  */{
      ...
      $protected: {
         ...
         _options: {
            ...
            footerTpl: undefined,
            /**
             * @cfg {Boolean} Устанавливает режим автоперерисовки набора элементов коллекции при изменении элементов.
             * @variant true Режим автоперерисовки набора элементов коллекции установлен.
             * @variant false Режим автоперерисовки набора элементов коллекции отменен.
             * @remark
