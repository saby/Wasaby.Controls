   ...
   var SearchMixin = /**@lends SBIS3.CONTROLS.SearchMixin.prototype  */{
      ...
      $protected: {
         ...
         _options: {
             ...
             *
             * Автодополнение отображает более релевантные результаты, когда поиск производится бо большему числу введенных символов.
             *
             * Когда для опции *startCharacter* установлено значение null, автоматическое отображение автодополнения отключено. Чтобы автодополнение отобразилось, после ввода символов нажимают клавишу Enter или кнопку "Лупа".
             *
             ...
             *
             * Отсутствие задержки может создавать повышенную нагрузку на сервер. Это происходит, автодополнение вызывается после каждого ввода или удаления символа, с учетом ограничения {@link startCharacter}.
             *
             * @see startCharacter
             */
            searchDelay : 500
