   ...
   var ItemsControlMixin = /**@lends SBIS3.CONTROLS.ItemsControlMixin.prototype  */{
      ...
      $protected: {
         ...
         _options: {
             ...
             * Поле источника данных, по которому производится группировка элементов коллекции.
             ...
             * @property {Function} method Метод группировки элементов.
             * Возвращает признак, по которому устанавливается отображение заголовка группы перед обрабатываемым элементом коллекции, так и самого элемента.
             * Аргументы функции:
             * <ol>
             ...
             * <ul>
             *    <li>Тип Boolean. В значении true заголовок будет отрисован.</li>
             *    <li>Тип Object. В этом случае объект может содержать два свойства:
             *       <ul>
             ...
             *    </li>
             * </ul>
             * @property {String} template (устаревшая опция) Шаблон заголовка группы. Используйте *contentTemplate*.
             * @property {String} contentTemplate Шаблон заголовка группы.
             ...
             * @property {Function} render Функция визуализации. Позволяет дополнительно преобразовать заголовок группы.
             * Аргументы функции:
             * <ol>
