define('js!SBIS3.CONTROLS.ItemsControlMixin', [
   ...
   var ItemsControlMixin = /**@lends SBIS3.CONTROLS.ItemsControlMixin.prototype  */{
      ...
      _unsetItemsEventHandlers: function () {
        ...
        * @remark
        * Когда установливается источник данных и задано значение в опции {@link items}, то поведение контрола:
        * <ol>
        *     <li>Сначала данные контрола отрисовываются из *items*.</li>
        *     <li>Данные будут обновлены после получения ответа от БЛ.</li>
        * </ol>
