define('js!SBIS3.CONTROLS.ItemsControlMixin', [
   ...
   var ItemsControlMixin = /**@lends SBIS3.CONTROLS.ItemsControlMixin.prototype  */{
      ...
      _getItemsProjection: function() {
        ...
        * @param {Boolean} itemsBySource Призак того, что items соответствуют источнику данных, который установлен для контрола.
        * При этом после reload не будет заменяться экземпляр items, а произойдет перенос данных, пришедших с БЛ в уже существующий экземпляр.
        * @example
