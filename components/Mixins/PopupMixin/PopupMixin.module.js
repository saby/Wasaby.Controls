   ...
   var PopupMixin = /** @lends SBIS3.CONTROLS.PopupMixin.prototype */ {
      $protected: {
         ...
         _options: {
             ...
             */
            isModal: false,
            // Не уменьшать размеры если не влезаем в экран - показываться в полный размер или высотой в экран
            // Должно быть включено по умолчанию, но есть кнопка с меню, меню которой перекроет ее саму - поэтому введен этот флаг
            fullHeight: true
         }
      },
