      ...
      _connectBindings: function () {
         ...
         this._options.observableControls.forEach(function (control) {
            ...
            this.subscribeTo(control, 'onFocusOut', function(e, destroyed, focusedControl) {
               ...
               if (self._list && (self._list === focusedControl || ~Array.prototype.indexOf(self._list.getChildControls(), focusedControl))) {
      ...
      _updateList: function() {
         ...
         if(list.hasChildControlByName('showAllButton')) {
            ...
            if(showButton) {
               ...
               if(Array.prototype.indexOf(button.getEventHandlers('onActivated'), this._showAllButtonHandler) === -1) {
