...
define('js!SBIS3.CONTROLS.DropdownListMixin', [],
    function () {
        /**
         * ћиксин, добавл€ющий поведение хранени€ одного или нескольких выбранных элементов
        ...
        var DropdownListMixin = /**@lends SBIS3.CONTROLS.MenuButtonMixin.prototype  */{
            $protected: {
                _options: {
                    /**
                     * @cfg {} Ўаблон отображени€ каждого элемента
                     */
                    itemTemplate: ''
                }
            },
            ...
            $constructor: function () {
                if (!this._options.displayField) {
                    //ѕо умолчанию отображаемое поле - 'title'
