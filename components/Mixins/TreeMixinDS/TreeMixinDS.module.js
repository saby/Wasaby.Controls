   ...
   var TreeMixinDS = /** @lends SBIS3.CONTROLS.TreeMixinDS.prototype */{
      ...
      expandNode: function (key) {
         ...
         if (!tree[key]){
            ...
            return this._dataSource.query(this._createTreeFilter(key), this.getSorting(), 0, this._limit).addCallback(function (dataSet) {
      ...
      _folderLoad: function(id) {
         ...
         this._loader = this._dataSource.query(filter, this.getSorting(), (id ? this._folderOffsets[id] : this._folderOffsets['null']) + this._limit, this._limit).addCallback(function (dataSet) {
