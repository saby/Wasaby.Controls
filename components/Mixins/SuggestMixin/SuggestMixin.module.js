   ...
   var SuggestMixin = /** @lends SBIS3.CONTROLS.SuggestMixin.prototype */{
      ...
      $protected: {
         _options: {
            ...
            /**
             * @cfg {Number} Минимальная длина введенного значения, при которой следует начать поиск.
             * @example
             * <pre class="brush: xml">
             ...
             * Список с большим количеством значений будет отображен с полосой прокрутки.
             * Отображение большого списка можно настроить, передав в настройки контрола выпадающего блока {@link list}
