define('js!SBIS3.CONTROLS.SuggestMixin', [
    ...
    * Получает готовый экземпляр {@link list контрола списка сущностей}, либо название компонента и опции.
    * Данный экземпляр контрола вставляется в контейнер, предоставляемый SBIS3.CONTROLS.PickerMixin.
   ...
   var SuggestMixin = /** @lends SBIS3.CONTROLS.SuggestMixin.prototype */{
      ...
      $protected: {
         _options: {
             ...
             * ![](/SuggestMixin01.png)
             * Для приведенного в примере поля связи autoShow установлено в true; при переходе фокуса на поле
             ...
             * Список значений этого блока можно отфильтровать, настроив опцию {@link listFilter}.
             * Если список содержит большое количество значений, то он будет отображен с полосой прокрутки.
             * Отображение списка с полосой прокрутки можно заменить на режим постраничной навигации. Для этого в опции
             * {@link list} установите для настроек контрола выпадающего блока опции {@link SBIS3.CONTROLS.ListView#showPaging}
             * и {@link SBIS3.CONTROLS.DSMixin#pageSize}.
             *
             * Подробнее о функционале автодополнения вы можете прочитать в описании к классу {@link SBIS3.CONTROLS.SuggestMixin}.
             * @example
             * <pre class="brush: xml">
             ...
             * будет построено автодополнение, ключевое поле {@link SBIS3.CONTROLS.DSMixin#keyField)
            ...
            /**
             * @cfg {Object} Настраивает параметры фильтрации для списка значений автодополнения.
             * @remark
