   ...
   var SuggestMixin = /** @lends SBIS3.CONTROLS.SuggestMixin.prototype */{
      ...
      $protected: {
         _options: {
            ...
            startChar: 3,
            /**
             * @cfg {Boolean} Режим автоматического отображения списка значений для автодополнения при получении фокуса контролом
             * @variant true: список значений отображается
             * @variant false: список значений не отображается
             * @remark
             ...
             * Для настройки автодополнения в поле связи используется опция {@link text}.
