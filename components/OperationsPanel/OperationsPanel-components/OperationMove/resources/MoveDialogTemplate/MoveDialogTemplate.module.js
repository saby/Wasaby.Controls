...
define('js!SBIS3.CONTROLS.MoveDialogTemplate', [
   ...
   var MoveDialogTemplate = Control.extend({
      ...
      _onReady: function() {
         ...
         if ($ws.helpers.instanceOfModule(this.getDataSource(), 'SBIS3.CONTROLS.SbisServiceSource') || $ws.helpers.instanceOfModule(this.getDataSource(),'SBIS3.CONTROLS.Data.Source.SbisService')) {
