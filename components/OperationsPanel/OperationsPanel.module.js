...
define('js!SBIS3.CONTROLS.OperationsPanel', [
   ...
   /**
    * Панель действий – это компонент для отображения действий над записями в связанном представлении данных ({@link SBIS3.CONTROLS.ListView} и любой его контрол-наследник).
    * Он состоит из всплывающей панели,по умолчанию скрытой, и кнопки управления её отображением.
    ...
    * конфигурируется иконка на панели действий, её положение и поведение при клике. Действия создаются как новые компоненты,
    * добавляемые внутрь панели действий.
    *
    ...
    *
    * По умолчанию панель действий скрыта. Для вызова панели в интерфейсе должна присутствовать кнопка управления панелью -
    * {@link SBIS3.CONTROLS.OperationsPanelButton}. Связывание кнопки и панели производят методом {@link SBIS3.CONTROLS.OperationsPanelButton#setLinkedPanel}.
    * Одной кнопкой можно управлять несколькими панелями.
    *
