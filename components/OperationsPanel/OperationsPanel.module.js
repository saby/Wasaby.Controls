...
define('js!SBIS3.CONTROLS.OperationsPanel', [
...
], function(Control, dotTplFn, OPStyles, CheckBox, MenuLink, PickerMixin, CollectionMixin, StaticSource, ArrayStrategy) {
   /**
   ...
   var OperationsPanel = Control.extend([CollectionMixin, PickerMixin],/** @lends SBIS3.CONTROLS.OperationsPanel.prototype */{
      ...
      /*TODO Убрвть это от сюда!!!*/
      _selectCurrentPage: function() {
         this.getLinkedView().setSelectedItemsAll()
      },
      _removeSelection: function() {
         this.getLinkedView().setSelectedItems([]);
      },
