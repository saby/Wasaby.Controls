...
define('js!SBIS3.CONTROLS.MoveDialog', [
   ...
   var MoveDialog = Dialog.extend({
      ...
      _onRootClick: function(event) {
         this._treeView._container.find('.controls-ListView__item-type-true').toggleClass('ws-hidden');
