   ...
   var Pager = CompoundControl.extend([ItemsControlMixin, Selectable],/** @lends SBIS3.CONTROLS.Paging.prototype */{
      ...
      $protected: {
         ...
         _options: {
            ...
            pagesCount: null,
            showPages: true,
            navigationToolbar: [true, true, true, true, false]
         }
      },
      ...
      _modifyOptions: function(cfg) {
          ...
          */
         if (!cfg.navigationToolbar) {
            if (cfg.mode === 'full') {
               cfg.navigationToolbar[4] = true;
            }
            cfg.navigationToolbar[2] = cfg.showPages;
         }
