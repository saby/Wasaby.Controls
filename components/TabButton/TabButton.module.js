...
define('js!SBIS3.CONTROLS.TabButton',
   ...
   var TabButton = RadioButtonBase.extend([IconMixin],/** @lends SBIS3.CONTROLS.TabButton.prototype */ {
      ...
      /*
        Метод перекрываем, т.к. нужно особое 'сквозное' поведение для вкладок: они должны переключаться, т.е. быть активны,
        при этом, вложенные контролы (например, редактирование по месту) в них должны выключаться при выключении TabControl
       */
