			...
			init: function (opt) {
				...
				return this.each(function () {
					...
					if (!$(this).data('colpickId')) {
						...
						//Setup hue selector
						options.selector = cal.find('div.colpick_color').bind('mousedown touchstart',downSelector);
						...
						cal.find('div.colpick_hue').bind('mousedown touchstart',downHue);
						...
						if (options.flat) {
							...
							$(this).bind(options.showEvent, show);
							cal.css({
								position:'absolute'
							});
						}
