 ...
 *
 * @public
 * @class SBIS3.CONTROLS.Columns.Preset.Cache
 */
define('js!SBIS3.CONTROLS.Columns.Preset.Cache',
   [
      'Core/Deferred',
      'Core/EventBus',
      'Core/UserConfig',
   ...
   function (Deferred, EventBus, UserConfig, PresetUnit) {
      ...
      var PresetCache = /**@lends SBIS3.CONTROLS.Columns.Preset.Cache.prototype*/ {
         /**
