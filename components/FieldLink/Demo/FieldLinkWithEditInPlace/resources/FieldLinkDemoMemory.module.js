 ...
 */
/* global define, $ws */
define('js!SBIS3.CONTROLS.Demo.FieldLinkDemoMemory', ['js!SBIS3.CONTROLS.Data.Source.Memory'], function (Memory) {
   'use strict';

   var FieldLinkDemoMemory = Memory.extend({
      /**
       * Применяет фильтр
       * @param {*} data Данные
