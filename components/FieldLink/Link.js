define('SBIS3.CONTROLS/FieldLink/Link', [
   ...
   function(ButtonBase, dotTplFn) {
      ...
      /**
       * Класс компонента "Ссылка для поля связи". Может быть использована в качестве метки поля связи.
