   ...
   var TabControl = CompoundControl.extend( /** @lends SBIS3.CONTROLS.TabControl.prototype */ {
      ...
      $protected: {
         ...
         _options: {
            ...
            loadType: 'cached',
            /**
             * @cfg {String} Режим фиксации корешков закладок.
             * В зависимости от режима позволяет либо навсегда зафискировать корешки закладок наверху страницы,
             * либо прижимать корешки к верху страницы, когда при скроллинге контрол уходит за пределы экрана, но ещё видна какая-то часть контрола.
             * @example
             * <pre>
             *     <option name="fixedHeader">sticky</option>
             * </pre>
             * @variant no не фиксировать корешки закладок;
             * @variant fixed зафиксировать корешки наверху страницы навсегда;
             * @variant sticky прижимать корешки к верху страницы, когда при скроллинге контрол уходит за пределы экрана, но ещё видна какая-то часть контрола;
             */
            fixedHeader: 'no',
            /**
