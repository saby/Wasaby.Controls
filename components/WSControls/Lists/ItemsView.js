define('js!WSControls/Lists/ItemsView', [
   ...
   'tmpl!WSControls/Lists/ItemsView/ItemTemplate',
   ...
   var ItemsView = BaseControl.extend(
      {
         _controlName: 'WSControls/Lists/ItemsView',
         _template: ItemsViewTpl,
         _enumIndexes: null,
         iWantVDOM: true,
         ...
         constructor: function (cfg) {
            ItemsView.superclass.constructor.apply(this, arguments);
         ...
         _beforeMount: function(newOptions) {
            this._itemTemplate = newOptions.itemTemplate || ItemTemplate;
         ...
         destroy: function() {
            ItemsView.superclass.destroy.apply(this, arguments);
            if (this._display) {
   ...
   /*ItemsView.getOptionTypes = function getOptionTypes(){
    return {
