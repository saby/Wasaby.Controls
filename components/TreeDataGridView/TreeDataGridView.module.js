define('js!SBIS3.CONTROLS.TreeDataGridView', [
   ...
   var
      ...
      getItemTemplateData = function (cfg) {
         ...
         config.addClasses = 'controls-DataGridView__tr controls-ListView__item js-controls-ListView__item ' + (cfg.className ? cfg.className : '') + config.classNodeType + config.classNodeState + config.classIsLoaded + config.classHasLoadedChild + config.classIsSelected + (cfg.noHover ? '' : ' controls-ListView__hoveredItem__withHover');
