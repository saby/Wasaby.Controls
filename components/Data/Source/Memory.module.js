   ...
   var Memory = Local.extend(/** @lends SBIS3.CONTROLS.Data.Source.Memory.prototype */{
      ...
      $constructor: function (cfg) {
         ...
         if ('strategy' in cfg && !('adapter' in cfg)) {
            ...
            $ws.single.ioc.resolve('ILogger').log(this._moduleName + '::$constructor', 'option "strategy" is deprecated and will be removed in 3.7.4. Use "adapter" instead.');
         }
         if ('keyField' in cfg && !('idProperty' in cfg)) {
            this._options.idProperty = cfg.keyField;
            $ws.single.ioc.resolve('ILogger').log(this._moduleName + '::$constructor', 'option "keyField" is deprecated and will be removed in 3.7.4. Use "idProperty" instead.');
         }
         this._reIndex();
      },
