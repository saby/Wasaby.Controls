...
define(
   ['js!SBIS3.CONTROLS.Data.Adapter.Sbis','js!SBIS3.CONTROLS.Data.Model','js!SBIS3.CONTROLS.Data.Source.DataSet','js!SBIS3.CONTROLS.Data.Factory','js!SBIS3.CONTROLS.Data.Source.Memory'],
   function (AdapterSbis,Model,DataSet,Factory) {
      'use strict';
      var sbisModel,sbisModelSet;
      beforeEach(function(){
         sbisModel = new Model({
