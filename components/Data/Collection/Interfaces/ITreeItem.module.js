/* global define, $ws */
define('js!SBIS3.CONTROLS.Data.Collection.ITreeItem', [
], function () {
   'use strict';

   /**
    * Интерфейс элемента дерева
    * @mixin SBIS3.CONTROLS.Data.Collection.ITreeItem
    * @implements SBIS3.CONTROLS.Data.Collection.ICollectionItem
    * @public
    * @author Мальцев Алексей
    */
   return /** @lends SBIS3.CONTROLS.Data.Collection.ITreeItem.prototype */{
      $protected: {
         _options: {
            /**
             * @cfg {SBIS3.CONTROLS.Data.Collection.ITreeItem} Родительский узел
             */
            parent: undefined,
       ...
       * @param {SBIS3.CONTROLS.Data.Collection.ITreeItem} [parent] Новый родительский узел. Если не передан, ссылка на родителя обнуляется.
       */
