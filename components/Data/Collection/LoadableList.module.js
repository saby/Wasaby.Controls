...
define('js!SBIS3.CONTROLS.Data.Collection.LoadableList', [
...
], function (List, IBindCollection, IBindProperty, ISourceLoadable, ObservableListMixin, LoadableListMixin) {
   'use strict';
   ...
   var LoadableList = List.extend([IBindCollection, IBindProperty, ObservableListMixin, ISourceLoadable, LoadableListMixin], /** @lends SBIS3.CONTROLS.Data.Collection.LoadableList.prototype */{
