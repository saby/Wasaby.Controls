...
define('js!SBIS3.CONTROLS.Data.Collection.LoadableTree', [
...
], function (ObservableTreeItem, LoadableTreeChildren, ISourceLoadable, LoadableTreeItemMixin, TreeMixin) {
   'use strict';
   ...
   var LoadableTree = ObservableTreeItem.extend([ISourceLoadable, LoadableTreeItemMixin, TreeMixin], /** @lends SBIS3.CONTROLS.Data.Collection.LoadableTree.prototype */{
