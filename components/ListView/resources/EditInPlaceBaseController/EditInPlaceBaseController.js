      ...
      var
         ...
         EditInPlaceBaseController = CompoundControl.extend([PendingOperationProducerMixin],/** @lends SBIS3.CONTROLS/ListView/resources/EditInPlaceBaseController/EditInPlaceBaseController.prototype */ {
            ...
            _needDestroyEip: function(afterAdd) {
               ...
               //При разрушении редакторов, фокус перейдёт на таблицу, и нажатия клавишь будет обрабатываться таблицей.
               ...
               //таблицей, т.к. редактроы разрушились, и будет показана карточка элемента таблицы. Такого происходить не должно.
               ...
               //т.к. зажатие клаваиши enter при добавлении, нетиповой сценарий, т.к. пустые записи создаваться не должны,
