      ...
      var ListView = CompoundControl.extend([CompoundActiveFixMixin, DecorableMixin, ItemsControlMixin, FormWidgetMixin, MultiSelectable, Selectable, DataBindMixin, DragNDropMixin, CommonHandlers, MoveHandlers], /** @lends SBIS3.CONTROLS.ListView.prototype */ {
         ...
         $protected: {
            ...
            _options: {
                ...
                * </ul>
                * @property {String} showMode Вид отображения операции.
                * По умолчанию отображается в зависимости от значений caption и icon:
                *  - Если указан только caption будет отображаться как ссылка.
                *  - Если указан только icon будет отображаться как иконка.
         ...
         * */
         ...
         showEip: function(model, options, withoutActivateFirstControl) {
            return this._canShowEip() ? this._getEditInPlace().showEip(model, options, withoutActivateFirstControl) : $ws.proto.Deferred.fail();
         },
