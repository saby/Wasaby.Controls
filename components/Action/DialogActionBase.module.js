define('js!SBIS3.CONTROLS.DialogActionBase', [
...
], function( cIndicator, cMerge, Deferred,ActionBase, Dialog, FloatArea, Model, InformationPopupManager, fcHelpers, colHelpers, cInstance){
   'use strict';
   ...
   var OpenDialogAction = ActionBase.extend(/** @lends SBIS3.CONTROLS.DialogActionBase.prototype */{
      ...
      _destroyModel: function(model){
         ...
         if (cInstance.instanceOfModule(collection.getDataSet && collection.getDataSet(), 'WS.Data/Collection/RecordSet')) {
      ...
      _createRecord: function(model, at, additionalData){
         var collection = this._options.linkedObject,
            rec;
         at = at || 0;
         if (cInstance.instanceOfModule(collection.getDataSet(), 'WS.Data/Collection/RecordSet')) {
