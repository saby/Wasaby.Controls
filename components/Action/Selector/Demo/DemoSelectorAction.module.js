...
define('js!SBIS3.CONTROLS.Demo.DemoSelectorAction', [
    ...
    function (CompoundControl, dotTplFn) {
       ...
       var DemoSelectorAction = CompoundControl.extend(/** @lends SBIS3.CONTROLS.Action.Action.prototype */{
          _dotTplFn: dotTplFn,
          $protected: {
          ...
          init: function() {
             ...
             var radioMultiselect = this.getChildControlByName('multiselect');
             var radioSelectionType = this.getChildControlByName('selectionType');

             var currentMultiselect = true;
             var currentSelectionType = 'leaf';
