...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_cmgg568cjedwgjzy.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_cmgg568cjedwgjzy.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_cmgg568cjedwgjzy.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_cmgg568cjedwgjzy.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_cmgg568cjedwgjzy.getAutoResizeBottomMargin(editor);
    ...
    if ($_cmgg568cjedwgjzy.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_216cg289jedwgjzu.resize(editor, oldSize);
    });
  };
  var $_c6nzx688jedwgjzs = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_c6nzx688jedwgjzs.register(editor, oldSize);
      $_216cg289jedwgjzu.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
