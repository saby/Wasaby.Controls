...
var tabfocus = (function () {
  ...
  var $_6ac2fvjmjedwglms = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_6ac2fvjmjedwglms.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_6dcsbcjfjedwglmm = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_6dcsbcjfjedwglmm.setup(editor);
  });
  function Plugin () {
  }
