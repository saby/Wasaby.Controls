...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_f4asemi6jedwglgg.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_f4asemi6jedwglgg.getPreviewDialogWidth(editor);
    var dialogHeight = $_f4asemi6jedwglgg.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_b39n93i7jedwglgi.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_aefp3qi4jedwglge = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_aefp3qi4jedwglge.open(editor);
    });
  };
  var $_7sfmh7i3jedwglgc = { register: register };
  ...
  var $_ehpd1gi9jedwglgl = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_7sfmh7i3jedwglgc.register(editor);
    $_ehpd1gi9jedwglgl.register(editor);
  });
  function Plugin () {
  }
