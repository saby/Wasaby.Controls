...
var textpattern = (function () {
  ...
  var $_1g6le0qhjedwgo4o = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_7s033lqpjedwgo50.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_7s033lqpjedwgo50.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_7s033lqpjedwgo50.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_7aka5yqmjedwgo4v.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_7aka5yqmjedwgo4v.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_7aka5yqmjedwgo4v.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !VK.modifierPressed(e)) {
        $_6vz6a0qljedwgo4s.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_6vz6a0qljedwgo4s.checkKeyCode(keyCodes, e)) {
        $_6vz6a0qljedwgo4s.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_6vz6a0qljedwgo4s.checkCharCode(charCodes, e)) {
  ...
  var $_ay14anqijedwgo4q = { setup: setup };

  PluginManager.add('textpattern', function (editor) {
    var patternsState = Cell($_1g6le0qhjedwgo4o.getPatterns(editor.settings));
    $_ay14anqijedwgo4q.setup(editor, patternsState);
    return $_4mdddhqgjedwgo4n.get(patternsState);
  });
  function Plugin () {
  }
