...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_3sxxwx9njedwgk60.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_145i4y9jjedwgk4x.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_f6gauu9ljedwgk4z.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_b48wmg9ojedwgk62 = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_9eiodz9ijedwgk4v = {
    open: function (editor) {
      var minWidth = $_145i4y9jjedwgk4x.getDialogMinWidth(editor);
      var minHeight = $_145i4y9jjedwgk4x.getDialogMinHeight(editor);
      var currentLanguage = $_b48wmg9ojedwgk62.getCurrentLanguage(editor);
      var currentLanguages = $_b48wmg9ojedwgk62.getLanguages(editor);
      var currentCode = $_f6gauu9ljedwgk4z.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_f6gauu9ljedwgk4z.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_3sxxwx9njedwgk60.isCodeSample(node)) {
        $_9eiodz9ijedwgk4v.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_2x9fvz9hjedwgk4t = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_3sxxwx9njedwgk60.trimArg($_3sxxwx9njedwgk60.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_3sxxwx9njedwgk60.trimArg($_3sxxwx9njedwgk60.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_eu5sg89pjedwgk65 = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_145i4y9jjedwgk4x.getContentCss(editor);
  ...
  var $_6csrvk9qjedwgk67 = { loadCss: loadCss };
  ...
  var $_b56nr69rjedwgk68 = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_eu5sg89pjedwgk65.setup(editor);
    $_b56nr69rjedwgk68.register(editor);
    $_2x9fvz9hjedwgk4t.register(editor);
    editor.on('init', function () {
      $_6csrvk9qjedwgk67.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_3sxxwx9njedwgk60.isCodeSample(ev.target)) {
        $_9eiodz9ijedwgk4v.open(editor);
      }
    });
    return $_f6gauu9ljedwgk4z;
  });
  function Plugin () {
  }
