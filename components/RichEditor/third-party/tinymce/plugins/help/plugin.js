...
var help = (function () {
  ...
  var never$1 = $_4f65ieaqjedwgkad.never;
  var always$1 = $_4f65ieaqjedwgkad.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_4f65ieaqjedwgkad.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_cljuxsasjedwgkag = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_1rvmvjaojedwgka3.map($_cljuxsasjedwgkag.shortcuts, function (shortcut) {
  ...
  var $_4r1ofoanjedwgk9v = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_619p7oaxjedwgkb2.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_619p7oaxjedwgkb2.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_619p7oaxjedwgkb2.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_619p7oaxjedwgkb2.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_10mmirayjedwgkb3.head(str).bind(function (head) {
      return $_10mmirayjedwgkb3.tail(str).map(function (tail) {
  ...
  var $_c05zibazjedwgkb6 = { urls: urls };

  var makeLink = $_4f65ieaqjedwgkad.curry($_b3x2oawjedwgkaz.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_1rvmvjaojedwgka3.find($_c05zibazjedwgkb6.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_942pbbavjedwgkav.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_1rvmvjaojedwgka3.filter(keys, $_4f65ieaqjedwgkad.not($_4f65ieaqjedwgkad.curry($_1rvmvjaojedwgka3.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_1rvmvjaojedwgka3.map(pluginKeys, function (key) {
  ...
  var $_f8ayroaujedwgkaj = { makeTab: makeTab$1 };
  ...
  var $_3bvth8b0jedwgkb9 = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_4r1ofoanjedwgk9v.makeTab(),
          $_f8ayroaujedwgkaj.makeTab(editor)
        ],
        buttons: $_3bvth8b0jedwgkb9.makeRow(),
  ...
  var $_g636mzamjedwgk9t = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_g636mzamjedwgk9t.open(editor, pluginUrl));
  };
  var $_808mykaljedwgk9s = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_g636mzamjedwgk9t.open(editor, pluginUrl)
    });
  ...
  var $_doa8ffb2jedwgkbb = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_doa8ffb2jedwgkbb.register(editor, pluginUrl);
    $_808mykaljedwgk9s.register(editor, pluginUrl);
