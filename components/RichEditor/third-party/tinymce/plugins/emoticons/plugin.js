...
var emoticons = (function () {
  ...
  var $_fet0nkahjedwgk9e = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_fet0nkahjedwgk9e.getHtml(pluginUrl);
  ...
  var $_8x14v6agjedwgk9c = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_8x14v6agjedwgk9c.register(editor, pluginUrl);
  });
  function Plugin () {
  }
