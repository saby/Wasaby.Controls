...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_awkgv9e5jedwgkw5.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_awkgv9e5jedwgkw5.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_awkgv9e5jedwgkw5.getSelectorConverter(editor)) {
      selectorConverter = $_awkgv9e5jedwgkw5.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_awkgv9e5jedwgkw5.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_awkgv9e5jedwgkw5.getCssGroups(editor));
      ...
      if (!$_awkgv9e5jedwgkw5.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_awkgv9e5jedwgkw5.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_6pg73pe0jedwgkvy.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_186ea0dzjedwgkvv = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_6pg73pe0jedwgkvy.setup(editor);
    return $_186ea0dzjedwgkvv.get(editor);
  });
  function Plugin () {
  }
