...
var contextmenu = (function () {
  ...
  var $_ckaq5ea2jedwgk8b = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_cbmjgya1jedwgk88.getContextMenu(editor);
  ...
  var $_3vgv1da5jedwgk8j = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_cbmjgya1jedwgk88.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_3vgv1da5jedwgk8j.show(editor, $_ckaq5ea2jedwgk8b.getPos(editor, e), visibleState, menu);
    });
  };
  var $_9a5344a0jedwgk86 = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_9a5344a0jedwgk86.setup(editor, visibleState, menu);
    return $_65xemm9zjedwgk83.get(visibleState);
  });
  function Plugin () {
  }
