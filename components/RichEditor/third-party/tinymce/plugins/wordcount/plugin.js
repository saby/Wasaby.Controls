...
var wordcount = (function () {
  ...
  var $_5210d8s4jedwgobb = {
    each: each,
    map: map
  };

  var SETS$1 = $_b979cas2jedwgob5.SETS;
  var OTHER = $_b979cas2jedwgob5.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_5210d8s4jedwgobb.map(string.split(''), memoized);
  };
  var $_7r31r1s3jedwgob9 = { classify: classify };

  var ci = $_b979cas2jedwgob5.characterIndices;
  ...
  var $_4s9j9ds5jedwgobd = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_b979cas2jedwgob5.EMPTY_STRING;
  var WHITESPACE$1 = $_b979cas2jedwgob5.WHITESPACE;
  var PUNCTUATION$1 = $_b979cas2jedwgob5.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_7r31r1s3jedwgob9.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_4s9j9ds5jedwgobd.isWordBoundary(map, i)) {
  ...
  var $_cqm4wbs1jedwgoax = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_cqm4wbs1jedwgoax.getWords(getTextContent(editor)).length;
  };
  var $_eg0oses0jedwgoaw = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_eg0oses0jedwgoaw.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_5mw50qrzjedwgoav = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_eg0oses0jedwgoaw.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_78ql39s6jedwgobf = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_78ql39s6jedwgobf.setup(editor);
    return $_5mw50qrzjedwgoav.get(editor);
  });
  function Plugin () {
  }
