   ...
   var TextBoxBase = CompoundControl.extend([FormWidgetMixin, DataBindMixin, CompoundActiveFixMixin], /** @lends SBIS3.CONTROLS.TextBoxBase.prototype*/ {
      ...
      $protected: {
         ...
         _options: {
             ...
             * При включённом режиме пробелы пробелы в начале и конце введенного текста будут обрезаны.
             ...
             * сам выбрал поле ввода, или в исключительных случаях - когда есть какой-то модальный диалог с полем ввода, и
