   ...
   var MenuButton = Button.extend( [PickerMixin, CollectionMixin, MenuButtonMixin], /** @lends SBIS3.CONTROLS.MenuButton.prototype */ {
      ...
      init: function(){
         ...
         $ws.helpers.trackElement(this._container, true).subscribe('onMove', function () {
            if (self._header) {
               self._header.css({
                  left: (self._headerAligment.horizontal == 'left') ? self._container.offset().left : self._container.offset().left - 16,
      ...
      _onAlignmentChangeHandler: function(alignment){
         if (alignment.horizontalAlign.side == 'right'){
            ...
            this._headerAligment.horizontal = 'right';
         } else {
            ...
            this._header.css('left', parseFloat(this._header.css('left')) + 16);
            this._headerAligment.horizontal = 'left';
         }
      },
      ...
      togglePicker: function(){
         ...
         this._header.css({
            left: (this._headerAligment.horizontal == 'left') ? this._container.offset().left : this._container.offset().left - 16,
