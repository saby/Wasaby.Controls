...
var reqfile = fs.readFileSync(root + '\\sbis3-ws\\ws\\ext\\requirejs\\r.js', {'encoding': 'utf-8'});
eval(reqfile);
var rjs = require;
require = baseRequire;
...
fs.writeFile(root+"/builderCfg.json", gultConfig, function(){
   ...
   child.on('exit', function (code, signal) {
      ...
      app.get('/cdn*', function(req, res) {
         if (req.url.indexOf('require-min.js')>-1){
            res.redirect('http://localhost:' + port+'/WS.Core/ext/requirejs/require.js');
         } else {
